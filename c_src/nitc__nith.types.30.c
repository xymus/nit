...
-1, /* empty */
-1, /* empty */
3066, /* AbstractArray[AExternCall] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
3068, /* AbstractArray[MAttributeDef] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
2940, /* MapRead[MModule, HashMap[MType, Array[MAttributeDef]]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
2941, /* MapRead[MType, Array[MAttributeDef]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
2121, /* HashMapNode[MType, Array[MAttributeDef]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
},
...
-1, /* empty */
-1, /* empty */
2122, /* NativeArray[nullable HashMapNode[MType, Array[MAttributeDef]]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
3069, /* AbstractArray[Array[MAttributeDef]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
2132, /* HashMapNode[MModule, HashMap[MType, Array[MAttributeDef]]] */
-1, /* empty */
-1, /* empty */
},
};
...
-1, /* empty */
-1, /* empty */
2133, /* NativeArray[nullable HashMapNode[MModule, HashMap[MType, Array[MAttributeDef]]]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
},
...
-1, /* empty */
-1, /* empty */
3070, /* AbstractArray[HashMap[MType, Array[MAttributeDef]]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
