...
short int var4 /* : Bool */;
{
var1 = ((int64_t(*)(val* self))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Collection__length]))(self); /* length on <self:Collection[nullable Object]>*/
}
{
...
int64_t core___core__Collection___length(val* self) {
int64_t var /* : Int */;
...
var6 = ((short int(*)(val* self, val* p0))((((int64_t)var_i&3)?class_info[((int64_t)var_i&3)]:var_i->class)->vft[COLOR_core__kernel__Object___61d_61d]))(var_i, var_item); /* == on <var_i:nullable Object>*/
var5 = var6;
}
if (var5){
var = 1;
...
int64_t core___core__Collection___count(val* self, val* p0) {
int64_t var /* : Int */;
val* var_item /* var item: nullable Object */;
int64_t var_nb /* var nb: Int */;
val* var_ /* var : Collection[nullable Object] */;
...
{
var6 = ((val*(*)(val* self))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Collection__iterator]))(self); /* iterator on <self:Collection[nullable Object]>*/
}
{
var7 = ((val*(*)(val* self))((((int64_t)var6&3)?class_info[((int64_t)var6&3)]:var6->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var6); /* item on <var6:Iterator[nullable Object]>*/
}
var = var7;
goto RET_LABEL;
RET_LABEL:;
...
{
var4 = ((int64_t(*)(val* self))((((int64_t)var_other&3)?class_info[((int64_t)var_other&3)]:var_other->class)->vft[COLOR_core__abstract_collection__Collection__length]))(var_other); /* length on <var_other:Collection[nullable Object]>*/
}
var_ol = var4;
{
var5 = ((int64_t(*)(val* self))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Collection__length]))(self); /* length on <self:Collection[nullable Object]>*/
}
var_l = var5;
{
...
if (var12){
{
var15 = ((val*(*)(val* self))((((int64_t)var_other&3)?class_info[((int64_t)var_other&3)]:var_other->class)->vft[COLOR_core__abstract_collection__Collection__first]))(var_other); /* first on <var_other:Collection[nullable Object]>*/
}
{
var16 = ((short int(*)(val* self, val* p0))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Collection__has]))(self, var15); /* has on <self:Collection[nullable Object]>*/
}
var = var16;
goto RET_LABEL;
} else {
...
var_ = var_other;
{
var17 = ((val*(*)(val* self))((((int64_t)var_&3)?class_info[((int64_t)var_&3)]:var_->class)->vft[COLOR_core__abstract_collection__Collection__iterator]))(var_); /* iterator on <var_:Collection[nullable Object]>*/
}
var_18 = var17;
for(;;) {
{
var19 = ((short int(*)(val* self))((((int64_t)var_18&3)?class_info[((int64_t)var_18&3)]:var_18->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_18); /* is_ok on <var_18:Iterator[nullable Object]>*/
}
if (var19){
} else {
goto BREAK_label;
...
{
var20 = ((val*(*)(val* self))((((int64_t)var_18&3)?class_info[((int64_t)var_18&3)]:var_18->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_18); /* item on <var_18:Iterator[nullable Object]>*/
}
var_x = var20;
{
var21 = ((short int(*)(val* self, val* p0))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Collection__has]))(self, var_x); /* has on <self:Collection[nullable Object]>*/
}
var22 = !var21;
if (var22){
var = 0;
...
{
((void(*)(val* self))((((int64_t)var_18&3)?class_info[((int64_t)var_18&3)]:var_18->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_18); /* next on <var_18:Iterator[nullable Object]>*/
}
}
BREAK_label: (void)0;
{
((void(*)(val* self))((((int64_t)var_18&3)?class_info[((int64_t)var_18&3)]:var_18->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_18); /* finish on <var_18:Iterator[nullable Object]>*/
}
var = 1;
goto RET_LABEL;
RET_LABEL:;
...
{
var2 = ((int64_t(*)(val* self))((((int64_t)var_other&3)?class_info[((int64_t)var_other&3)]:var_other->class)->vft[COLOR_core__abstract_collection__Collection__length]))(var_other); /* length on <var_other:Collection[nullable Object]>*/
}
{
...
var_e = var10;
{
var11 = ((int64_t(*)(val* self, val* p0))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Collection__count]))(self, var_e); /* count on <self:Collection[nullable Object]>*/
}
{
var12 = ((int64_t(*)(val* self, val* p0))((((int64_t)var_other&3)?class_info[((int64_t)var_other&3)]:var_other->class)->vft[COLOR_core__abstract_collection__Collection__count]))(var_other, var_e); /* count on <var_other:Collection[nullable Object]>*/
}
{
...
int64_t core___core__Ref___Collection__length(val* self) {
int64_t var /* : Int */;
var = 1l;
goto RET_LABEL;
RET_LABEL:;
...
var5 = ((short int(*)(val* self, val* p0))((((int64_t)var1&3)?class_info[((int64_t)var1&3)]:var1->class)->vft[COLOR_core__kernel__Object___61d_61d]))(var1, var_an_item); /* == on <var1:nullable Object>*/
var4 = var5;
}
var = var4;
goto RET_LABEL;
...
int64_t core___core__Ref___Collection__count(val* self, val* p0) {
int64_t var /* : Int */;
val* var_an_item /* var an_item: nullable Object */;
val* var1 /* : nullable Object */;
val* var3 /* : nullable Object */;
...
type_struct = (((int64_t)self&3)?type_info[((int64_t)self&3)]:self->type)->resolution_table->types[COLOR_core__Collection__core__SimpleCollection___35dE];
cltype = type_struct->color;
idtype = type_struct->id;
if(cltype >= (((int64_t)p0&3)?type_info[((int64_t)p0&3)]:p0->type)->table_size) {
var = 0;
...
var_i = var4;
{
((void(*)(val* self, val* p0))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__abstract_collection__SimpleCollection__add]))(self, var_i); /* add on <self:SimpleCollection[nullable Object]>*/
}
{
((void(*)(val* self))((((int64_t)var_2&3)?class_info[((int64_t)var_2&3)]:var_2->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_2); /* next on <var_2:Iterator[nullable Object]>*/
}
...
int64_t core___core__Set___Collection__count(val* self, val* p0) {
int64_t var /* : Int */;
val* var_item /* var item: nullable Object */;
short int var1 /* : Bool */;
var_item = p0;
{
var1 = ((short int(*)(val* self, val* p0))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Collection__has]))(self, var_item); /* has on <self:Set[nullable Object]>*/
}
if (var1){
var = 1l;
goto RET_LABEL;
...
{
var3 = ((int64_t(*)(val* self))((((int64_t)var_other&3)?class_info[((int64_t)var_other&3)]:var_other->class)->vft[COLOR_core__abstract_collection__Collection__length]))(var_other); /* length on <var_other:nullable Object(Set[nullable Object])>*/
}
{
var4 = ((int64_t(*)(val* self))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Collection__length]))(self); /* length on <self:Set[nullable Object]>*/
}
{
...
int64_t core___core__Set___core__kernel__Object__hash(val* self) {
int64_t var /* : Int */;
int64_t var1 /* : Int */;
int64_t var2 /* : Int */;
short int var4 /* : Bool */;
...
int64_t var19 /* : Int */;
{
var1 = ((int64_t(*)(val* self))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Collection__length]))(self); /* length on <self:Set[nullable Object]>*/
}
{
...
var_ = self;
{
var6 = ((val*(*)(val* self))((((int64_t)var_&3)?class_info[((int64_t)var_&3)]:var_->class)->vft[COLOR_core__abstract_collection__Collection__iterator]))(var_); /* iterator on <var_:Set[nullable Object]>*/
}
var_7 = var6;
for(;;) {
{
...
if (var10){
{
var12 = ((int64_t(*)(val* self))((((int64_t)var_e&3)?class_info[((int64_t)var_e&3)]:var_e->class)->vft[COLOR_core__kernel__Object__hash]))(var_e); /* hash on <var_e:nullable Object(Object)>*/
}
{
...
type_struct = (((int64_t)self&3)?type_info[((int64_t)self&3)]:self->type)->resolution_table->types[COLOR_core__Set__core__Set___35dE];
cltype = type_struct->color;
idtype = type_struct->id;
if(cltype >= (((int64_t)p0&3)?type_info[((int64_t)p0&3)]:p0->type)->table_size) {
var1 = 0;
...
var_other = p0;
{
var2 = ((val*(*)(val* self))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Set__new_set]))(self); /* new_set on <self:Set[nullable Object]>*/
}
var_nhs = var2;
{
...
type_struct = (((int64_t)self&3)?type_info[((int64_t)self&3)]:self->type)->resolution_table->types[COLOR_core__kernel__Object__SELF];
cltype = type_struct->color;
idtype = type_struct->id;
if(cltype >= (((int64_t)var1&3)?type_info[((int64_t)var1&3)]:var1->type)->table_size) {
var2 = 0;
} else {
var2 = (((int64_t)var1&3)?type_info[((int64_t)var1&3)]:var1->type)->type_table[cltype] == idtype;
}
if (unlikely(!var2)) {
var_class_name = var1 == NULL ? "null" : (((int64_t)var1&3)?type_info[((int64_t)var1&3)]:var1->type)->name;
...
var_key = p0;
{
var1 = ((short int(*)(val* self, val* p0))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__abstract_collection__MapRead__has_key]))(self, var_key); /* has_key on <self:MapRead[nullable Object, nullable Object]>*/
}
if (var1){
{
var2 = ((val*(*)(val* self, val* p0))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__abstract_collection__MapRead___91d_93d]))(self, var_key); /* [] on <self:MapRead[nullable Object, nullable Object]>*/
}
var = var2;
goto RET_LABEL;
} else {
...
{
var3 = ((int64_t(*)(val* self))((((int64_t)var_other&3)?class_info[((int64_t)var_other&3)]:var_other->class)->vft[COLOR_core__abstract_collection__MapRead__length]))(var_other); /* length on <var_other:nullable Object(MapRead[nullable Object, nullable Object])>*/
}
{
var4 = ((int64_t(*)(val* self))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__abstract_collection__MapRead__length]))(self); /* length on <self:MapRead[nullable Object, nullable Object]>*/
}
{
{ /* Inline kernel$Int$!= (var3,var4) on <var3:Int> */
var7 = var3 == var4;
...
var_ = self;
{
var9 = ((val*(*)(val* self))((((int64_t)var_&3)?class_info[((int64_t)var_&3)]:var_->class)->vft[COLOR_core__abstract_collection__MapRead__iterator]))(var_); /* iterator on <var_:MapRead[nullable Object, nullable Object]>*/
}
var_10 = var9;
for(;;) {
{
var11 = ((short int(*)(val* self))((((int64_t)var_10&3)?class_info[((int64_t)var_10&3)]:var_10->class)->vft[COLOR_core__abstract_collection__MapIterator__is_ok]))(var_10); /* is_ok on <var_10:MapIterator[nullable Object, nullable Object]>*/
}
if (var11){
} else {
goto BREAK_label;
...
{
var12 = ((val*(*)(val* self))((((int64_t)var_10&3)?class_info[((int64_t)var_10&3)]:var_10->class)->vft[COLOR_core__abstract_collection__MapIterator__key]))(var_10); /* key on <var_10:MapIterator[nullable Object, nullable Object]>*/
}
var_k = var12;
{
var13 = ((val*(*)(val* self))((((int64_t)var_10&3)?class_info[((int64_t)var_10&3)]:var_10->class)->vft[COLOR_core__abstract_collection__MapIterator__item]))(var_10); /* item on <var_10:MapIterator[nullable Object, nullable Object]>*/
}
var_v = var13;
{
var14 = ((short int(*)(val* self, val* p0))((((int64_t)var_other&3)?class_info[((int64_t)var_other&3)]:var_other->class)->vft[COLOR_core__abstract_collection__MapRead__has_key]))(var_other, var_k); /* has_key on <var_other:nullable Object(MapRead[nullable Object, nullable Object])>*/
}
var15 = !var14;
if (var15){
var = 0;
...
{
var16 = ((val*(*)(val* self, val* p0))((((int64_t)var_other&3)?class_info[((int64_t)var_other&3)]:var_other->class)->vft[COLOR_core__abstract_collection__MapRead___91d_93d]))(var_other, var_k); /* [] on <var_other:nullable Object(MapRead[nullable Object, nullable Object])>*/
}
if (var16 == NULL) {
var17 = (var_v != NULL);
} else {
var18 = ((short int(*)(val* self, val* p0))((((int64_t)var16&3)?class_info[((int64_t)var16&3)]:var16->class)->vft[COLOR_core__kernel__Object___33d_61d]))(var16, var_v); /* != on <var16:nullable Object>*/
var17 = var18;
}
if (var17){
var = 0;
...
{
((void(*)(val* self))((((int64_t)var_10&3)?class_info[((int64_t)var_10&3)]:var_10->class)->vft[COLOR_core__abstract_collection__MapIterator__next]))(var_10); /* next on <var_10:MapIterator[nullable Object, nullable Object]>*/
}
}
BREAK_label: (void)0;
{
...
int64_t core___core__MapRead___core__kernel__Object__hash(val* self) {
int64_t var /* : Int */;
int64_t var1 /* : Int */;
int64_t var_res /* var res: Int */;
val* var_ /* var : MapRead[nullable Object, nullable Object] */;
...
int64_t var37 /* : Int */;
{
var1 = ((int64_t(*)(val* self))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__abstract_collection__MapRead__length]))(self); /* length on <self:MapRead[nullable Object, nullable Object]>*/
}
var_res = var1;
var_ = self;
{
var2 = ((val*(*)(val* self))((((int64_t)var_&3)?class_info[((int64_t)var_&3)]:var_->class)->vft[COLOR_core__abstract_collection__MapRead__iterator]))(var_); /* iterator on <var_:MapRead[nullable Object, nullable Object]>*/
}
var_3 = var2;
for(;;) {
{
var4 = ((short int(*)(val* self))((((int64_t)var_3&3)?class_info[((int64_t)var_3&3)]:var_3->class)->vft[COLOR_core__abstract_collection__MapIterator__is_ok]))(var_3); /* is_ok on <var_3:MapIterator[nullable Object, nullable Object]>*/
}
if (var4){
} else {
goto BREAK_label;
...
{
var5 = ((val*(*)(val* self))((((int64_t)var_3&3)?class_info[((int64_t)var_3&3)]:var_3->class)->vft[COLOR_core__abstract_collection__MapIterator__key]))(var_3); /* key on <var_3:MapIterator[nullable Object, nullable Object]>*/
}
var_k = var5;
{
var6 = ((val*(*)(val* self))((((int64_t)var_3&3)?class_info[((int64_t)var_3&3)]:var_3->class)->vft[COLOR_core__abstract_collection__MapIterator__item]))(var_3); /* item on <var_3:MapIterator[nullable Object, nullable Object]>*/
}
var_v = var6;
if (var_k == NULL) {
var7 = 0; /* is null */
...
if (0) {
var8 = ((short int(*)(val* self, val* p0))((((int64_t)var_k&3)?class_info[((int64_t)var_k&3)]:var_k->class)->vft[COLOR_core__kernel__Object___33d_61d]))(var_k, ((val*)NULL)); /* != on <var_k:nullable Object>*/
var7 = var8;
}
if (var7){
{
var9 = ((int64_t(*)(val* self))((((int64_t)var_k&3)?class_info[((int64_t)var_k&3)]:var_k->class)->vft[COLOR_core__kernel__Object__hash]))(var_k); /* hash on <var_k:nullable Object(Object)>*/
}
{
...
if (0) {
var22 = ((short int(*)(val* self, val* p0))((((int64_t)var_v&3)?class_info[((int64_t)var_v&3)]:var_v->class)->vft[COLOR_core__kernel__Object___33d_61d]))(var_v, ((val*)NULL)); /* != on <var_v:nullable Object>*/
var21 = var22;
}
if (var21){
{
var23 = ((int64_t(*)(val* self))((((int64_t)var_v&3)?class_info[((int64_t)var_v&3)]:var_v->class)->vft[COLOR_core__kernel__Object__hash]))(var_v); /* hash on <var_v:nullable Object(Object)>*/
}
{
...
{
((void(*)(val* self))((((int64_t)var_3&3)?class_info[((int64_t)var_3&3)]:var_3->class)->vft[COLOR_core__abstract_collection__MapIterator__next]))(var_3); /* next on <var_3:MapIterator[nullable Object, nullable Object]>*/
}
}
BREAK_label: (void)0;
{
...
type_struct = (((int64_t)self&3)?type_info[((int64_t)self&3)]:self->type)->resolution_table->types[COLOR_core__MapRead__core__Map___35dK__core__Map___35dV];
cltype = type_struct->color;
idtype = type_struct->id;
if(cltype >= (((int64_t)p0&3)?type_info[((int64_t)p0&3)]:p0->type)->table_size) {
var = 0;
...
var_map = p0;
{
var1 = ((val*(*)(val* self))((((int64_t)var_map&3)?class_info[((int64_t)var_map&3)]:var_map->class)->vft[COLOR_core__abstract_collection__MapRead__iterator]))(var_map); /* iterator on <var_map:MapRead[nullable Object, nullable Object]>*/
}
var_i = var1;
for(;;) {
{
var2 = ((short int(*)(val* self))((((int64_t)var_i&3)?class_info[((int64_t)var_i&3)]:var_i->class)->vft[COLOR_core__abstract_collection__MapIterator__is_ok]))(var_i); /* is_ok on <var_i:MapIterator[nullable Object, nullable Object]>*/
}
if (var2){
{
var3 = ((val*(*)(val* self))((((int64_t)var_i&3)?class_info[((int64_t)var_i&3)]:var_i->class)->vft[COLOR_core__abstract_collection__MapIterator__key]))(var_i); /* key on <var_i:MapIterator[nullable Object, nullable Object]>*/
}
{
var4 = ((val*(*)(val* self))((((int64_t)var_i&3)?class_info[((int64_t)var_i&3)]:var_i->class)->vft[COLOR_core__abstract_collection__MapIterator__item]))(var_i); /* item on <var_i:MapIterator[nullable Object, nullable Object]>*/
}
{
((void(*)(val* self, val* p0, val* p1))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Map___91d_93d_61d]))(self, var3, var4); /* []= on <self:Map[nullable Object, nullable Object]>*/
}
{
...
{
var4 = ((short int(*)(val* self))((((int64_t)var1&3)?class_info[((int64_t)var1&3)]:var1->class)->vft[COLOR_core__abstract_collection__MapIterator__is_ok]))(var1); /* is_ok on <var1:MapIterator[nullable Object, nullable Object]>*/
}
var = var4;
goto RET_LABEL;
RET_LABEL:;
...
{
((void(*)(val* self))((((int64_t)var&3)?class_info[((int64_t)var&3)]:var->class)->vft[COLOR_core__abstract_collection__MapIterator__next]))(var); /* next on <var:MapIterator[nullable Object, nullable Object]>*/
}
RET_LABEL:;
}
...
{
var4 = ((val*(*)(val* self))((((int64_t)var1&3)?class_info[((int64_t)var1&3)]:var1->class)->vft[COLOR_core__abstract_collection__MapIterator__key]))(var1); /* key on <var1:MapIterator[nullable Object, nullable Object]>*/
}
var = var4;
goto RET_LABEL;
RET_LABEL:;
...
{
var4 = ((val*(*)(val* self))((((int64_t)var1&3)?class_info[((int64_t)var1&3)]:var1->class)->vft[COLOR_core__abstract_collection__MapIterator__item]))(var1); /* item on <var1:MapIterator[nullable Object, nullable Object]>*/
}
var = var4;
goto RET_LABEL;
RET_LABEL:;
...
val* var3 /* : nullable Object */;
{
var1 = ((short int(*)(val* self))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Collection__is_empty]))(self); /* is_empty on <self:SequenceRead[nullable Object]>*/
}
var2 = !var1;
if (unlikely(!var2)) {
if(catchStack.cursor >= 0){
...
{
var3 = ((val*(*)(val* self, int64_t p0))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__abstract_collection__SequenceRead___91d_93d]))(self, 0l); /* [] on <self:SequenceRead[nullable Object]>*/
}
var = var3;
goto RET_LABEL;
RET_LABEL:;
...
{
var3 = ((int64_t(*)(val* self))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Collection__length]))(self); /* length on <self:SequenceRead[nullable Object]>*/
}
{
...
{
var8 = ((val*(*)(val* self, int64_t p0))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__abstract_collection__SequenceRead___91d_93d]))(self, var4); /* [] on <self:SequenceRead[nullable Object]>*/
}
var = var8;
goto RET_LABEL;
RET_LABEL:;
...
int64_t core___core__SequenceRead___index_of(val* self, val* p0) {
int64_t var /* : Int */;
val* var_item /* var item: nullable Object */;
int64_t var1 /* : Int */;
var_item = p0;
{
var1 = ((int64_t(*)(val* self, val* p0, int64_t p1))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__abstract_collection__SequenceRead__index_of_from]))(self, var_item, 0l); /* index_of_from on <self:SequenceRead[nullable Object]>*/
}
var = var1;
goto RET_LABEL;
RET_LABEL:;
...
int64_t core___core__SequenceRead___last_index_of(val* self, val* p0) {
int64_t var /* : Int */;
val* var_item /* var item: nullable Object */;
int64_t var1 /* : Int */;
int64_t var2 /* : Int */;
...
var_item = p0;
{
var1 = ((int64_t(*)(val* self))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Collection__length]))(self); /* length on <self:SequenceRead[nullable Object]>*/
}
{
...
{
var6 = ((int64_t(*)(val* self, val* p0, int64_t p1))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__abstract_collection__SequenceRead__last_index_of_from]))(self, var_item, var2); /* last_index_of_from on <self:SequenceRead[nullable Object]>*/
}
var = var6;
goto RET_LABEL;
RET_LABEL:;
...
int64_t core___core__SequenceRead___index_of_from(val* self, val* p0, int64_t p1) {
int64_t var /* : Int */;
val* var_item /* var item: nullable Object */;
...
var_p = 0l;
{
var1 = ((val*(*)(val* self))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Collection__iterator]))(self); /* iterator on <self:SequenceRead[nullable Object]>*/
}
var_i = var1;
for(;;) {
{
var2 = ((short int(*)(val* self))((((int64_t)var_i&3)?class_info[((int64_t)var_i&3)]:var_i->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_i); /* is_ok on <var_i:IndexedIterator[nullable Object]>*/
}
if (var2){
{
...
if (var4){
{
var8 = ((val*(*)(val* self))((((int64_t)var_i&3)?class_info[((int64_t)var_i&3)]:var_i->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_i); /* item on <var_i:IndexedIterator[nullable Object]>*/
}
if (var8 == NULL) {
var9 = (var_item == NULL);
} else {
var10 = ((short int(*)(val* self, val* p0))((((int64_t)var8&3)?class_info[((int64_t)var8&3)]:var8->class)->vft[COLOR_core__kernel__Object___61d_61d]))(var8, var_item); /* == on <var8:nullable Object>*/
var9 = var10;
}
var3 = var9;
} else {
...
if (var3){
{
var11 = ((int64_t(*)(val* self))((((int64_t)var_i&3)?class_info[((int64_t)var_i&3)]:var_i->class)->vft[COLOR_core__abstract_collection__IndexedIterator__index]))(var_i); /* index on <var_i:IndexedIterator[nullable Object]>*/
}
var = var11;
goto RET_LABEL;
} else {
...
{
((void(*)(val* self))((((int64_t)var_i&3)?class_info[((int64_t)var_i&3)]:var_i->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_i); /* next on <var_i:IndexedIterator[nullable Object]>*/
}
{
...
int64_t core___core__SequenceRead___last_index_of_from(val* self, val* p0, int64_t p1) {
int64_t var /* : Int */;
val* var_item /* var item: nullable Object */;
int64_t var_pos /* var pos: Int */;
...
if (var1){
{
var5 = ((val*(*)(val* self, int64_t p0))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__abstract_collection__SequenceRead___91d_93d]))(self, var_i); /* [] on <self:SequenceRead[nullable Object]>*/
}
if (var5 == NULL) {
var6 = (var_item == NULL);
} else {
var7 = ((short int(*)(val* self, val* p0))((((int64_t)var5&3)?class_info[((int64_t)var5&3)]:var5->class)->vft[COLOR_core__kernel__Object___61d_61d]))(var5, var_item); /* == on <var5:nullable Object>*/
var6 = var7;
}
if (var6){
var = var_i;
...
var1 = (((int64_t)var_o&3)?type_info[((int64_t)var_o&3)]:var_o->type)->type_table[cltype] == idtype;
}
}
var2 = !var1;
if (var2){
...
var_l = var3;
{
var4 = ((int64_t(*)(val* self))((((int64_t)var_o&3)?class_info[((int64_t)var_o&3)]:var_o->class)->vft[COLOR_core__abstract_collection__Collection__length]))(var_o); /* length on <var_o:nullable Object(SequenceRead[nullable Object])>*/
}
{
...
if (var9){
{
var15 = ((val*(*)(val* self, int64_t p0))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__abstract_collection__SequenceRead___91d_93d]))(self, var_i); /* [] on <self:SequenceRead[nullable Object]>*/
}
{
var16 = ((val*(*)(val* self, int64_t p0))((((int64_t)var_o&3)?class_info[((int64_t)var_o&3)]:var_o->class)->vft[COLOR_core__abstract_collection__SequenceRead___91d_93d]))(var_o, var_i); /* [] on <var_o:nullable Object(SequenceRead[nullable Object])>*/
}
if (var15 == NULL) {
var17 = (var16 != NULL);
} else {
var18 = ((short int(*)(val* self, val* p0))((((int64_t)var15&3)?class_info[((int64_t)var15&3)]:var15->class)->vft[COLOR_core__kernel__Object___33d_61d]))(var15, var16); /* != on <var15:nullable Object>*/
var17 = var18;
}
if (var17){
var = 0;
...
int64_t core___core__SequenceRead___core__kernel__Object__hash(val* self) {
int64_t var /* : Int */;
int64_t var1 /* : Int */;
int64_t var2 /* : Int */;
short int var4 /* : Bool */;
...
var_ = self;
{
var6 = ((val*(*)(val* self))((((int64_t)var_&3)?class_info[((int64_t)var_&3)]:var_->class)->vft[COLOR_core__abstract_collection__Collection__iterator]))(var_); /* iterator on <var_:SequenceRead[nullable Object]>*/
}
var_7 = var6;
for(;;) {
{
var8 = ((short int(*)(val* self))((((int64_t)var_7&3)?class_info[((int64_t)var_7&3)]:var_7->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_7); /* is_ok on <var_7:IndexedIterator[nullable Object]>*/
}
if (var8){
} else {
goto BREAK_label;
...
{
var9 = ((val*(*)(val* self))((((int64_t)var_7&3)?class_info[((int64_t)var_7&3)]:var_7->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_7); /* item on <var_7:IndexedIterator[nullable Object]>*/
}
var_e = var9;
{
...
if (0) {
var25 = ((short int(*)(val* self, val* p0))((((int64_t)var_e&3)?class_info[((int64_t)var_e&3)]:var_e->class)->vft[COLOR_core__kernel__Object___33d_61d]))(var_e, ((val*)NULL)); /* != on <var_e:nullable Object>*/
var24 = var25;
}
if (var24){
{
var26 = ((int64_t(*)(val* self))((((int64_t)var_e&3)?class_info[((int64_t)var_e&3)]:var_e->class)->vft[COLOR_core__kernel__Object__hash]))(var_e); /* hash on <var_e:nullable Object(Object)>*/
}
{
...
{
((void(*)(val* self))((((int64_t)var_7&3)?class_info[((int64_t)var_7&3)]:var_7->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_7); /* next on <var_7:IndexedIterator[nullable Object]>*/
}
}
BREAK_label: (void)0;
{
((void(*)(val* self))((((int64_t)var_7&3)?class_info[((int64_t)var_7&3)]:var_7->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_7); /* finish on <var_7:IndexedIterator[nullable Object]>*/
}
var = var_res;
goto RET_LABEL;
RET_LABEL:;
...
val* core___core__SequenceRead___iterator_from(val* self, int64_t p0) {
...
if (var3){
{
var7 = ((short int(*)(val* self))((((int64_t)var_res&3)?class_info[((int64_t)var_res&3)]:var_res->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_res); /* is_ok on <var_res:IndexedIterator[nullable Object]>*/
}
var2 = var7;
} else {
var2 = var_;
...
if (var2){
{
((void(*)(val* self))((((int64_t)var_res&3)?class_info[((int64_t)var_res&3)]:var_res->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_res); /* next on <var_res:IndexedIterator[nullable Object]>*/
}
{
...
val* core___core__SequenceRead___reverse_iterator_from(val* self, int64_t p0) {
val* var /* : IndexedIterator[nullable Object] */;
int64_t var_pos /* var pos: Int */;
...
var_pos = p0;
{
var1 = ((val*(*)(val* self))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__abstract_collection__SequenceRead__reverse_iterator]))(self); /* reverse_iterator on <self:SequenceRead[nullable Object]>*/
}
var_res = var1;
for(;;) {
{
...
/* Covariant cast for argument 0 (item) <p0:nullable Object> isa E */
/* <p0:nullable Object> isa E */
type_struct = (((int64_t)self&3)?type_info[((int64_t)self&3)]:self->type)->resolution_table->types[COLOR_core__Sequence___35dE];
cltype = type_struct->color;
idtype = type_struct->id;
is_nullable = type_struct->is_nullable;
if(p0 == NULL) {
...
var_item = p0;
{
((void(*)(val* self, int64_t p0, val* p1))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Sequence___91d_93d_61d]))(self, 0l, var_item); /* []= on <self:Sequence[nullable Object]>*/
}
RET_LABEL:;
}
...
var_e = p0;
{
((void(*)(val* self, val* p0))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Sequence__push]))(self, var_e); /* push on <self:Sequence[nullable Object]>*/
}
RET_LABEL:;
}
...
/* Covariant cast for argument 0 (coll) <p0:Collection[nullable Object]> isa Collection[E] */
/* <p0:Collection[nullable Object]> isa Collection[E] */
type_struct = (((int64_t)self&3)?type_info[((int64_t)self&3)]:self->type)->resolution_table->types[COLOR_core__Collection__core__Sequence___35dE];
cltype = type_struct->color;
idtype = type_struct->id;
if(cltype >= (((int64_t)p0&3)?type_info[((int64_t)p0&3)]:p0->type)->table_size) {
var = 0;
...
var_coll = p0;
{
((void(*)(val* self, val* p0))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__abstract_collection__SimpleCollection__add_all]))(self, var_coll); /* add_all on <self:Sequence[nullable Object]>*/
}
RET_LABEL:;
}
...
var_coll = p0;
{
((void(*)(val* self, val* p0, int64_t p1))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Sequence__insert_all]))(self, var_coll, 0l); /* insert_all on <self:Sequence[nullable Object]>*/
}
RET_LABEL:;
}
...
void core___core__Sequence___insert(val* self, val* p0, int64_t p1) {
const char* var_class_name;
var_class_name = self == NULL ? "null" : (((int64_t)self&3)?type_info[((int64_t)self&3)]:self->type)->name;
...
void core___core__Sequence___insert_all(val* self, val* p0, int64_t p1) {
short int var /* : Bool */;
int cltype;
int idtype;
const struct type* type_struct;
...
if (var2){
{
var9 = ((int64_t(*)(val* self))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Collection__length]))(self); /* length on <self:Sequence[nullable Object]>*/
}
{
...
{
var17 = ((int64_t(*)(val* self))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Collection__length]))(self); /* length on <self:Sequence[nullable Object]>*/
}
{
...
var_21 = var_coll;
{
var22 = ((val*(*)(val* self))((((int64_t)var_21&3)?class_info[((int64_t)var_21&3)]:var_21->class)->vft[COLOR_core__abstract_collection__Collection__iterator]))(var_21); /* iterator on <var_21:Collection[nullable Object]>*/
}
var_23 = var22;
for(;;) {
{
var24 = ((short int(*)(val* self))((((int64_t)var_23&3)?class_info[((int64_t)var_23&3)]:var_23->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_23); /* is_ok on <var_23:Iterator[nullable Object]>*/
}
if (var24){
} else {
goto BREAK_label;
...
{
var25 = ((val*(*)(val* self))((((int64_t)var_23&3)?class_info[((int64_t)var_23&3)]:var_23->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_23); /* item on <var_23:Iterator[nullable Object]>*/
}
var_c = var25;
{
((void(*)(val* self, val* p0, int64_t p1))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Sequence__insert]))(self, var_c, var_index); /* insert on <self:Sequence[nullable Object]>*/
}
{
...
var_index = var26;
{
((void(*)(val* self))((((int64_t)var_23&3)?class_info[((int64_t)var_23&3)]:var_23->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_23); /* next on <var_23:Iterator[nullable Object]>*/
}
}
BREAK_label: (void)0;
{
((void(*)(val* self))((((int64_t)var_23&3)?class_info[((int64_t)var_23&3)]:var_23->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_23); /* finish on <var_23:Iterator[nullable Object]>*/
}
RET_LABEL:;
}
/* method abstract_collection$Sequence$remove_at for (self: Sequence[nullable Object], Int) */
void core___core__Sequence___remove_at(val* self, int64_t p0) {
const char* var_class_name;
var_class_name = self == NULL ? "null" : (((int64_t)self&3)?type_info[((int64_t)self&3)]:self->type)->name;
...
var1 = NEW_core__abstract_collection__CoupleMapIterator((((int64_t)self&3)?type_info[((int64_t)self&3)]:self->type)->resolution_table->types[COLOR_core__abstract_collection__CoupleMapIterator__core__CoupleMap___35dK__core__CoupleMap___35dV]);
{
...
{
var2 = ((val*(*)(val* self))((((int64_t)var1&3)?class_info[((int64_t)var1&3)]:var1->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var1); /* item on <var1:Iterator[Couple[nullable Object, nullable Object]]>*/
}
{
...
{
var2 = ((short int(*)(val* self))((((int64_t)var1&3)?class_info[((int64_t)var1&3)]:var1->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var1); /* is_ok on <var1:Iterator[Couple[nullable Object, nullable Object]]>*/
}
var = var2;
goto RET_LABEL;
RET_LABEL:;
...
{
((void(*)(val* self))((((int64_t)var&3)?class_info[((int64_t)var&3)]:var->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var); /* next on <var:Iterator[Couple[nullable Object, nullable Object]]>*/
}
RET_LABEL:;
}
