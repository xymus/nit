...
-1, /* empty */
-1, /* empty */
1264, /* MapKeysIterator[String, nullable MProperty] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1265, /* HashMapKeys[MType, HashMap[String, nullable MProperty]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
2473, /* Collection[HashMap[String, nullable MProperty]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1266, /* HashMapValues[MType, HashMap[String, nullable MProperty]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
2675, /* MapIterator[MType, HashMap[String, nullable MProperty]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1267, /* HashMapIterator[MType, HashMap[String, nullable MProperty]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
2756, /* nullable HashMapNode[MType, HashMap[String, nullable MProperty]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1268, /* HashMapNode[MType, HashMap[String, nullable MProperty]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1269, /* NativeArray[nullable HashMapNode[MType, HashMap[String, nullable MProperty]]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
2557, /* AbstractArrayRead[HashMap[String, nullable MProperty]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
3012, /* AbstractArray[HashMap[String, nullable MProperty]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1270, /* Array[HashMap[String, nullable MProperty]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1271, /* MapValuesIterator[MType, HashMap[String, nullable MProperty]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1272, /* NativeArray[HashMap[String, nullable MProperty]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1273, /* ArrayIterator[HashMap[String, nullable MProperty]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1274, /* ArrayReverseIterator[HashMap[String, nullable MProperty]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1275, /* MapKeysIterator[MType, HashMap[String, nullable MProperty]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1276, /* HashMapKeys[MModule, HashMap2[MType, String, nullable MProperty]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
2474, /* Collection[HashMap2[MType, String, nullable MProperty]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1277, /* HashMapValues[MModule, HashMap2[MType, String, nullable MProperty]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
2676, /* MapIterator[MModule, HashMap2[MType, String, nullable MProperty]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1278, /* HashMapIterator[MModule, HashMap2[MType, String, nullable MProperty]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
2757, /* nullable HashMapNode[MModule, HashMap2[MType, String, nullable MProperty]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1279, /* HashMapNode[MModule, HashMap2[MType, String, nullable MProperty]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1280, /* NativeArray[nullable HashMapNode[MModule, HashMap2[MType, String, nullable MProperty]]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
2558, /* AbstractArrayRead[HashMap2[MType, String, nullable MProperty]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
3013, /* AbstractArray[HashMap2[MType, String, nullable MProperty]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1281, /* Array[HashMap2[MType, String, nullable MProperty]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1282, /* MapValuesIterator[MModule, HashMap2[MType, String, nullable MProperty]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1283, /* NativeArray[HashMap2[MType, String, nullable MProperty]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1284, /* ArrayIterator[HashMap2[MType, String, nullable MProperty]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1285, /* ArrayReverseIterator[HashMap2[MType, String, nullable MProperty]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1286, /* MapKeysIterator[MModule, HashMap2[MType, String, nullable MProperty]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
const struct type type_core__hash_collection__HashMapKeys__nitc__MModule__core__Array__core__String = {
1287,
"HashMapKeys[MModule, Array[String]]", /* class_name_string */
145,
0,
&resolution_table_core__hash_collection__HashMapKeys__nitc__MModule__core__Array__core__String,
205,
{
2380, /* Object */
2401, /* nullable Object */
...
-1, /* empty */
-1, /* empty */
1287, /* HashMapKeys[MModule, Array[String]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
0, /* dummy */
{
&type_core__HashMap__nitc__MModule__core__Array__core__String, /* HashMap[K, V]: HashMap[MModule, Array[String]] */
&type_core__MapKeysIterator__nitc__MModule__core__Array__core__String, /* MapKeysIterator[K, V]: MapKeysIterator[MModule, Array[String]] */
NULL, /* empty */
NULL, /* empty */
NULL, /* empty */
NULL, /* empty */
...
const struct type type_core__hash_collection__HashMapValues__nitc__MModule__core__Array__core__String = {
1288,
"HashMapValues[MModule, Array[String]]", /* class_name_string */
145,
0,
&resolution_table_core__hash_collection__HashMapValues__nitc__MModule__core__Array__core__String,
205,
{
2380, /* Object */
2401, /* nullable Object */
...
-1, /* empty */
-1, /* empty */
1288, /* HashMapValues[MModule, Array[String]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
const struct types resolution_table_core__hash_collection__HashMapValues__nitc__MModule__core__Array__core__String = {
0, /* dummy */
{
&type_core__HashMap__nitc__MModule__core__Array__core__String, /* HashMap[K, V]: HashMap[MModule, Array[String]] */
&type_core__MapValuesIterator__nitc__MModule__core__Array__core__String, /* MapValuesIterator[K, V]: MapValuesIterator[MModule, Array[String]] */
NULL, /* empty */
NULL, /* empty */
NULL, /* empty */
NULL, /* empty */
...
const struct type type_core__hash_collection__HashMapIterator__nitc__MModule__core__Array__core__String = {
1289,
"HashMapIterator[MModule, Array[String]]", /* class_name_string */
98,
0,
&resolution_table_core__hash_collection__HashMapIterator__nitc__MModule__core__Array__core__String,
158,
{
2380, /* Object */
2401, /* nullable Object */
...
-1, /* empty */
-1, /* empty */
2677, /* MapIterator[MModule, Array[String]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1289, /* HashMapIterator[MModule, Array[String]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
const struct types resolution_table_core__hash_collection__HashMapIterator__nitc__MModule__core__Array__core__String = {
0, /* dummy */
{
&type_core__HashMap__nitc__MModule__core__Array__core__String, /* HashMap[K, V]: HashMap[MModule, Array[String]] */
}
...
const struct type type_core__hash_collection__HashMapNode__nitc__MModule__core__Array__core__String = {
1290,
"HashMapNode[MModule, Array[String]]", /* class_name_string */
96,
0,
&resolution_table_core__hash_collection__HashMapNode__nitc__MModule__core__Array__core__String,
156,
{
2380, /* Object */
2401, /* nullable Object */
...
-1, /* empty */
-1, /* empty */
2758, /* nullable HashMapNode[MModule, Array[String]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1290, /* HashMapNode[MModule, Array[String]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
const struct types resolution_table_core__hash_collection__HashMapNode__nitc__MModule__core__Array__core__String = {
0, /* dummy */
{
...
const struct type type_core__NativeArray__nullable__core__hash_collection__HashMapNode__nitc__MModule__core__Array__core__String = {
1291,
"NativeArray[nullable HashMapNode[MModule, Array[String]]]", /* class_name_string */
147,
0,
&resolution_table_core__NativeArray__nullable__core__hash_collection__HashMapNode__nitc__MModule__core__Array__core__String,
228,
{
2380, /* Object */
2401, /* nullable Object */
...
-1, /* empty */
-1, /* empty */
1291, /* NativeArray[nullable HashMapNode[MModule, Array[String]]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
const struct types resolution_table_core__NativeArray__nullable__core__hash_collection__HashMapNode__nitc__MModule__core__Array__core__String = {
0, /* dummy */
{
&type_nullable__core__hash_collection__HashMapNode__nitc__MModule__core__Array__core__String, /* E: nullable HashMapNode[MModule, Array[String]] */
&type_core__NativeArray__nullable__core__hash_collection__HashMapNode__nitc__MModule__core__Array__core__String, /* NativeArray[E]: NativeArray[nullable HashMapNode[MModule, Array[String]]] */
}
};
...
-1, /* empty */
-1, /* empty */
1292, /* MapValuesIterator[MModule, Array[String]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1293, /* MapKeysIterator[MModule, Array[String]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1294, /* HashMapKeys[String, nullable MModule] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1295, /* HashMapValues[String, nullable MModule] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
2678, /* MapIterator[String, nullable MModule] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1296, /* HashMapIterator[String, nullable MModule] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
2759, /* nullable HashMapNode[String, nullable MModule] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1297, /* HashMapNode[String, nullable MModule] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1298, /* NativeArray[nullable HashMapNode[String, nullable MModule]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
2559, /* AbstractArrayRead[nullable MModule] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
3014, /* AbstractArray[nullable MModule] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1300, /* MapValuesIterator[String, nullable MModule] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1304, /* MapKeysIterator[String, nullable MModule] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1305, /* HashMapKeys[String, nullable MGroup] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
