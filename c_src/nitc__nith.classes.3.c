...
/* runtime class nitc__TKwimport: nitc::TKwimport (dead=false; need_corpse=false)*/
...
self = nit_alloc(sizeof(struct instance) + 11*sizeof(nitattribute_t));
self->type = type;
self->class = &class_nitc__TKwimport;
self->attrs[COLOR_nitc__modelbuilder_base__ANode___is_broken].s = 0; /* _is_broken on <self:TKwimport exact> */
self->attrs[COLOR_nitc__parser_nodes__Token___is_loose].s = 0; /* _is_loose on <self:TKwimport exact> */
return self;
}
/* runtime class nitc__TKwclass: nitc::TKwclass (dead=false; need_corpse=false)*/
...
self = nit_alloc(sizeof(struct instance) + 11*sizeof(nitattribute_t));
self->type = type;
self->class = &class_nitc__TKwclass;
self->attrs[COLOR_nitc__modelbuilder_base__ANode___is_broken].s = 0; /* _is_broken on <self:TKwclass exact> */
self->attrs[COLOR_nitc__parser_nodes__Token___is_loose].s = 0; /* _is_loose on <self:TKwclass exact> */
return self;
}
/* runtime class nitc__TKwabstract: nitc::TKwabstract (dead=false; need_corpse=false)*/
...
self = nit_alloc(sizeof(struct instance) + 11*sizeof(nitattribute_t));
self->type = type;
self->class = &class_nitc__TKwabstract;
self->attrs[COLOR_nitc__modelbuilder_base__ANode___is_broken].s = 0; /* _is_broken on <self:TKwabstract exact> */
self->attrs[COLOR_nitc__parser_nodes__Token___is_loose].s = 0; /* _is_loose on <self:TKwabstract exact> */
return self;
}
/* runtime class nitc__TKwinterface: nitc::TKwinterface (dead=false; need_corpse=false)*/
...
self = nit_alloc(sizeof(struct instance) + 11*sizeof(nitattribute_t));
self->type = type;
self->class = &class_nitc__TKwinterface;
self->attrs[COLOR_nitc__modelbuilder_base__ANode___is_broken].s = 0; /* _is_broken on <self:TKwinterface exact> */
self->attrs[COLOR_nitc__parser_nodes__Token___is_loose].s = 0; /* _is_loose on <self:TKwinterface exact> */
return self;
}
/* runtime class nitc__TKwenum: nitc::TKwenum (dead=false; need_corpse=false)*/
...
self = nit_alloc(sizeof(struct instance) + 11*sizeof(nitattribute_t));
self->type = type;
self->class = &class_nitc__TKwenum;
self->attrs[COLOR_nitc__modelbuilder_base__ANode___is_broken].s = 0; /* _is_broken on <self:TKwenum exact> */
self->attrs[COLOR_nitc__parser_nodes__Token___is_loose].s = 0; /* _is_loose on <self:TKwenum exact> */
return self;
}
/* runtime class nitc__TKwend: nitc::TKwend (dead=false; need_corpse=false)*/
...
self = nit_alloc(sizeof(struct instance) + 11*sizeof(nitattribute_t));
self->type = type;
self->class = &class_nitc__TKwend;
self->attrs[COLOR_nitc__modelbuilder_base__ANode___is_broken].s = 0; /* _is_broken on <self:TKwend exact> */
self->attrs[COLOR_nitc__parser_nodes__Token___is_loose].s = 0; /* _is_loose on <self:TKwend exact> */
return self;
}
/* runtime class nitc__TKwmeth: nitc::TKwmeth (dead=false; need_corpse=false)*/
...
self = nit_alloc(sizeof(struct instance) + 11*sizeof(nitattribute_t));
self->type = type;
self->class = &class_nitc__TKwmeth;
self->attrs[COLOR_nitc__modelbuilder_base__ANode___is_broken].s = 0; /* _is_broken on <self:TKwmeth exact> */
self->attrs[COLOR_nitc__parser_nodes__Token___is_loose].s = 0; /* _is_loose on <self:TKwmeth exact> */
return self;
}
/* runtime class nitc__TKwtype: nitc::TKwtype (dead=false; need_corpse=false)*/
...
self = nit_alloc(sizeof(struct instance) + 11*sizeof(nitattribute_t));
self->type = type;
self->class = &class_nitc__TKwtype;
self->attrs[COLOR_nitc__modelbuilder_base__ANode___is_broken].s = 0; /* _is_broken on <self:TKwtype exact> */
self->attrs[COLOR_nitc__parser_nodes__Token___is_loose].s = 0; /* _is_loose on <self:TKwtype exact> */
return self;
}
/* runtime class nitc__TKwinit: nitc::TKwinit (dead=false; need_corpse=false)*/
...
self = nit_alloc(sizeof(struct instance) + 11*sizeof(nitattribute_t));
self->type = type;
self->class = &class_nitc__TKwinit;
self->attrs[COLOR_nitc__modelbuilder_base__ANode___is_broken].s = 0; /* _is_broken on <self:TKwinit exact> */
self->attrs[COLOR_nitc__parser_nodes__Token___is_loose].s = 0; /* _is_loose on <self:TKwinit exact> */
return self;
}
/* runtime class nitc__TKwredef: nitc::TKwredef (dead=false; need_corpse=false)*/
...
self = nit_alloc(sizeof(struct instance) + 11*sizeof(nitattribute_t));
self->type = type;
self->class = &class_nitc__TKwredef;
self->attrs[COLOR_nitc__modelbuilder_base__ANode___is_broken].s = 0; /* _is_broken on <self:TKwredef exact> */
self->attrs[COLOR_nitc__parser_nodes__Token___is_loose].s = 0; /* _is_loose on <self:TKwredef exact> */
return self;
}
/* runtime class nitc__TKwis: nitc::TKwis (dead=false; need_corpse=false)*/
...
self = nit_alloc(sizeof(struct instance) + 11*sizeof(nitattribute_t));
self->type = type;
self->class = &class_nitc__TKwis;
self->attrs[COLOR_nitc__modelbuilder_base__ANode___is_broken].s = 0; /* _is_broken on <self:TKwis exact> */
self->attrs[COLOR_nitc__parser_nodes__Token___is_loose].s = 0; /* _is_loose on <self:TKwis exact> */
return self;
}
/* runtime class nitc__TKwdo: nitc::TKwdo (dead=false; need_corpse=false)*/
...
self = nit_alloc(sizeof(struct instance) + 11*sizeof(nitattribute_t));
self->type = type;
self->class = &class_nitc__TKwdo;
self->attrs[COLOR_nitc__modelbuilder_base__ANode___is_broken].s = 0; /* _is_broken on <self:TKwdo exact> */
...
self = nit_alloc(sizeof(struct instance) + 11*sizeof(nitattribute_t));
self->type = type;
self->class = &class_nitc__TKwvar;
self->attrs[COLOR_nitc__modelbuilder_base__ANode___is_broken].s = 0; /* _is_broken on <self:TKwvar exact> */
...
(nitmethod_t)nitc__typing___ANode___bad_expr_message, /* pointer to parser_nodes:TKwextern:typing$ANode$bad_expr_message */
...
(nitmethod_t)nitc__typing___ANode___bad_expr_message, /* pointer to parser_nodes:TKwpublic:typing$ANode$bad_expr_message */
...
(nitmethod_t)nitc__typing___ANode___bad_expr_message, /* pointer to parser_nodes:TKwprotected:typing$ANode$bad_expr_message */
...
(nitmethod_t)nitc__typing___ANode___bad_expr_message, /* pointer to parser_nodes:TKwprivate:typing$ANode$bad_expr_message */
...
(nitmethod_t)nitc__typing___ANode___bad_expr_message, /* pointer to parser_nodes:TKwintrude:typing$ANode$bad_expr_message */
...
(nitmethod_t)nitc__typing___ANode___bad_expr_message, /* pointer to parser_nodes:TKwif:typing$ANode$bad_expr_message */
...
(nitmethod_t)nitc__typing___ANode___bad_expr_message, /* pointer to parser_nodes:TKwthen:typing$ANode$bad_expr_message */
...
(nitmethod_t)nitc__typing___ANode___bad_expr_message, /* pointer to parser_nodes:TKwelse:typing$ANode$bad_expr_message */
...
(nitmethod_t)nitc__typing___ANode___bad_expr_message, /* pointer to parser_nodes:TKwwhile:typing$ANode$bad_expr_message */
...
(nitmethod_t)nitc__typing___ANode___bad_expr_message, /* pointer to parser_nodes:TKwloop:typing$ANode$bad_expr_message */
...
(nitmethod_t)nitc__typing___ANode___bad_expr_message, /* pointer to parser_nodes:TKwfor:typing$ANode$bad_expr_message */
...
(nitmethod_t)nitc__typing___ANode___bad_expr_message, /* pointer to parser_nodes:TKwin:typing$ANode$bad_expr_message */
...
(nitmethod_t)nitc__typing___ANode___bad_expr_message, /* pointer to parser_nodes:TKwand:typing$ANode$bad_expr_message */
...
(nitmethod_t)nitc__typing___ANode___bad_expr_message, /* pointer to parser_nodes:TKwor:typing$ANode$bad_expr_message */
...
(nitmethod_t)nitc__typing___ANode___bad_expr_message, /* pointer to parser_nodes:TKwimplies:typing$ANode$bad_expr_message */
...
(nitmethod_t)nitc__typing___ANode___bad_expr_message, /* pointer to parser_nodes:TKwnot:typing$ANode$bad_expr_message */
...
(nitmethod_t)nitc__typing___ANode___bad_expr_message, /* pointer to parser_nodes:TKwreturn:typing$ANode$bad_expr_message */
...
(nitmethod_t)nitc__typing___ANode___bad_expr_message, /* pointer to parser_nodes:TKwcontinue:typing$ANode$bad_expr_message */
...
(nitmethod_t)nitc__typing___ANode___bad_expr_message, /* pointer to parser_nodes:TKwbreak:typing$ANode$bad_expr_message */
...
(nitmethod_t)nitc__typing___ANode___bad_expr_message, /* pointer to parser_nodes:TKwabort:typing$ANode$bad_expr_message */
...
(nitmethod_t)nitc__typing___ANode___bad_expr_message, /* pointer to parser_nodes:TKwassert:typing$ANode$bad_expr_message */
