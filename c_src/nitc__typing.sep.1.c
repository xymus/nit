...
var57 = "";
var58 = core__flat___NativeString___to_s_full(var57, 0l, 0l);
var56 = var58;
varonce55 = var56;
}
...
int64_t var118 /* : Int */;
int64_t var120 /* : Int */;
int64_t var_nbargs /* var nbargs: Int */;
int64_t var121 /* : Int */;
...
int64_t var268 /* : Int */;
int64_t var_min_arity /* var min_arity: Int */;
int64_t var269 /* : Int */;
int64_t var271 /* : Int */;
int64_t var272 /* : Int */;
int64_t var273 /* : Int */;
...
int64_t var279 /* : Int */;
int64_t var_vararg_decl /* var vararg_decl: Int */;
int64_t var_j /* var j: Int */;
int64_t var_i280 /* var i: Int */;
int64_t var281 /* : Int */;
int64_t var_282 /* var : Int */;
...
{
var113 = ((val*(*)(val* self))((((int64_t)var112&3)?class_info[((int64_t)var112&3)]:var112->class)->vft[COLOR_core__abstract_collection__SequenceRead__last]))(var112); /* last on <var112:SequenceRead[Char]>*/
}
{
{ /* Inline kernel$Char$== (var113,'=') on <var113:nullable Object(Char)> */
var117 = (uint32_t)((int64_t)(var113)>>2);
var116 = var117 == '=';
var114 = var116;
goto RET_LABEL115;
RET_LABEL115:(void)0;
...
for(;;) {
{
var10 = ((short int(*)(val* self))((((int64_t)var_9&3)?class_info[((int64_t)var_9&3)]:var_9->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_9); /* is_ok on <var_9:IndexedIterator[nullable MType]>*/
}
if (var10){
} else {
goto BREAK_label;
...
{
var11 = ((val*(*)(val* self))((((int64_t)var_9&3)?class_info[((int64_t)var_9&3)]:var_9->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_9); /* item on <var_9:IndexedIterator[nullable MType]>*/
}
var_t1 = var11;
if (var_t1 == NULL) {
var12 = 1; /* is null */
...
for(;;) {
{
var22 = ((short int(*)(val* self))((((int64_t)var_21&3)?class_info[((int64_t)var_21&3)]:var_21->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_21); /* is_ok on <var_21:IndexedIterator[nullable MType]>*/
}
if (var22){
} else {
goto BREAK_label23;
...
{
var24 = ((val*(*)(val* self))((((int64_t)var_21&3)?class_info[((int64_t)var_21&3)]:var_21->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_21); /* item on <var_21:IndexedIterator[nullable MType]>*/
}
var_t2 = var24;
if (var_t2 == NULL) {
var25 = 1; /* is null */
...
{
((void(*)(val* self))((((int64_t)var_21&3)?class_info[((int64_t)var_21&3)]:var_21->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_21); /* next on <var_21:IndexedIterator[nullable MType]>*/
}
}
BREAK_label23: (void)0;
{
((void(*)(val* self))((((int64_t)var_21&3)?class_info[((int64_t)var_21&3)]:var_21->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_21); /* finish on <var_21:IndexedIterator[nullable MType]>*/
}
if (var_found){
var = var_t1;
goto RET_LABEL;
...
{
((void(*)(val* self))((((int64_t)var_9&3)?class_info[((int64_t)var_9&3)]:var_9->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_9); /* next on <var_9:IndexedIterator[nullable MType]>*/
}
}
BREAK_label: (void)0;
{
((void(*)(val* self))((((int64_t)var_9&3)?class_info[((int64_t)var_9&3)]:var_9->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_9); /* finish on <var_9:IndexedIterator[nullable MType]>*/
}
var = ((val*)NULL);
goto RET_LABEL;
RET_LABEL:;
...
int64_t nitc__typing___AExpr___vararg_decl(val* self) {
int64_t var /* : Int */;
int64_t var1 /* : Int */;
...
/* method typing$AExpr$vararg_decl= for (self: AExpr, Int) */
void nitc__typing___AExpr___vararg_decl_61d(val* self, int64_t p0) {
