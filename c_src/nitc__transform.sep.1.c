...
for(;;) {
{
var41 = ((short int(*)(val* self))((((int64_t)var_40&3)?class_info[((int64_t)var_40&3)]:var_40->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_40); /* is_ok on <var_40:Iterator[AForGroup]>*/
}
if (var41){
} else {
goto BREAK_label;
...
{
var42 = ((val*(*)(val* self))((((int64_t)var_40&3)?class_info[((int64_t)var_40&3)]:var_40->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_40); /* item on <var_40:Iterator[AForGroup]>*/
}
var_g = var42;
{
...
{
((void(*)(val* self))((((int64_t)var_40&3)?class_info[((int64_t)var_40&3)]:var_40->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_40); /* next on <var_40:Iterator[AForGroup]>*/
}
}
BREAK_label: (void)0;
{
((void(*)(val* self))((((int64_t)var_40&3)?class_info[((int64_t)var_40&3)]:var_40->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_40); /* finish on <var_40:Iterator[AForGroup]>*/
}
{
...
var28 = (short int)((int64_t)(var25)>>2);
var29 = !var28;
var3 = var29;
} else {
var3 = var_15;
...
for(;;) {
{
var30 = ((short int(*)(val* self))((((int64_t)var_29&3)?class_info[((int64_t)var_29&3)]:var_29->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_29); /* is_ok on <var_29:Iterator[AExpr]>*/
}
if (var30){
} else {
goto BREAK_label;
...
{
var31 = ((val*(*)(val* self))((((int64_t)var_29&3)?class_info[((int64_t)var_29&3)]:var_29->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_29); /* item on <var_29:Iterator[AExpr]>*/
}
var_nexpr = var31;
{
nitc__astbuilder___ABlockExpr___AExpr__add(var_nblock, var_nexpr); /* Direct call astbuilder$ABlockExpr$add on <var_nblock:ABlockExpr>*/
...
{
((void(*)(val* self))((((int64_t)var_29&3)?class_info[((int64_t)var_29&3)]:var_29->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_29); /* next on <var_29:Iterator[AExpr]>*/
}
}
BREAK_label: (void)0;
{
((void(*)(val* self))((((int64_t)var_29&3)?class_info[((int64_t)var_29&3)]:var_29->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_29); /* finish on <var_29:Iterator[AExpr]>*/
}
{
...
for(;;) {
{
var12 = ((short int(*)(val* self))((((int64_t)var_11&3)?class_info[((int64_t)var_11&3)]:var_11->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_11); /* is_ok on <var_11:IndexedIterator[AExpr]>*/
}
if (var12){
} else {
goto BREAK_label;
...
{
var13 = ((val*(*)(val* self))((((int64_t)var_11&3)?class_info[((int64_t)var_11&3)]:var_11->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_11); /* item on <var_11:IndexedIterator[AExpr]>*/
}
var_a = var13;
{
...
{
((void(*)(val* self))((((int64_t)var_11&3)?class_info[((int64_t)var_11&3)]:var_11->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_11); /* next on <var_11:IndexedIterator[AExpr]>*/
}
}
BREAK_label: (void)0;
{
((void(*)(val* self))((((int64_t)var_11&3)?class_info[((int64_t)var_11&3)]:var_11->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_11); /* finish on <var_11:IndexedIterator[AExpr]>*/
}
{
{ /* Inline transform$TransformVisitor$builder (var_v) on <var_v:TransformVisitor> */
var18 = var_v->attrs[COLOR_nitc__transform__TransformVisitor___builder].val; /* _builder on <var_v:TransformVisitor> */
