...
{
((void(*)(val* self, val* p0, int64_t p1))(var9->class->vft[COLOR_core__array__Array__with_native]))(var9, var10, 2l); /* with_native on <var9:Array[Option]>*/
}
}
{
...
var_15 = var14;
{
var16 = ((val*(*)(val* self))((((int64_t)var_15&3)?class_info[((int64_t)var_15&3)]:var_15->class)->vft[COLOR_core__abstract_collection__Collection__iterator]))(var_15); /* iterator on <var_15:Sequence[Phase]>*/
}
var_17 = var16;
for(;;) {
{
var18 = ((short int(*)(val* self))((((int64_t)var_17&3)?class_info[((int64_t)var_17&3)]:var_17->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_17); /* is_ok on <var_17:IndexedIterator[Phase]>*/
}
if (var18){
} else {
goto BREAK_label19;
...
{
var20 = ((val*(*)(val* self))((((int64_t)var_17&3)?class_info[((int64_t)var_17&3)]:var_17->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_17); /* item on <var_17:IndexedIterator[Phase]>*/
}
var_p = var20;
{
...
var_deps = var24;
{
var25 = ((short int(*)(val* self))((((int64_t)var_deps&3)?class_info[((int64_t)var_deps&3)]:var_deps->class)->vft[COLOR_core__abstract_collection__Collection__is_empty]))(var_deps); /* is_empty on <var_deps:Collection[Phase]>*/
}
if (var25){
var26 = glob_sys;
{
...
{
((void(*)(val* self))((((int64_t)var_17&3)?class_info[((int64_t)var_17&3)]:var_17->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_17); /* next on <var_17:IndexedIterator[Phase]>*/
}
}
BREAK_label19: (void)0;
{
((void(*)(val* self))((((int64_t)var_17&3)?class_info[((int64_t)var_17&3)]:var_17->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_17); /* finish on <var_17:IndexedIterator[Phase]>*/
}
var45 = glob_sys;
{
...
for(;;) {
{
var53 = ((short int(*)(val* self))((((int64_t)var_52&3)?class_info[((int64_t)var_52&3)]:var_52->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_52); /* is_ok on <var_52:Iterator[Phase]>*/
}
if (var53){
} else {
goto BREAK_label54;
...
{
var55 = ((val*(*)(val* self))((((int64_t)var_52&3)?class_info[((int64_t)var_52&3)]:var_52->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_52); /* item on <var_52:Iterator[Phase]>*/
}
var_p56 = var55;
{
...
{
((void(*)(val* self))((((int64_t)var_52&3)?class_info[((int64_t)var_52&3)]:var_52->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_52); /* next on <var_52:Iterator[Phase]>*/
}
}
BREAK_label54: (void)0;
{
((void(*)(val* self))((((int64_t)var_52&3)?class_info[((int64_t)var_52&3)]:var_52->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_52); /* finish on <var_52:Iterator[Phase]>*/
}
var64 = !var_found;
if (var64){
...
var82 = (short int)((int64_t)(var79)>>2);
if (var82){
{
...
int64_t var71 /* : Int */;
int64_t var73 /* : Int */;
int64_t var_errcount /* var errcount: Int */;
int64_t var74 /* : Int */;
int64_t var76 /* : Int */;
...
var_ = var_phases;
{
var8 = ((val*(*)(val* self))((((int64_t)var_&3)?class_info[((int64_t)var_&3)]:var_->class)->vft[COLOR_core__abstract_collection__Collection__iterator]))(var_); /* iterator on <var_:Sequence[Phase]>*/
}
var_9 = var8;
for(;;) {
{
var10 = ((short int(*)(val* self))((((int64_t)var_9&3)?class_info[((int64_t)var_9&3)]:var_9->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_9); /* is_ok on <var_9:IndexedIterator[Phase]>*/
}
if (var10){
} else {
goto BREAK_label;
...
{
var11 = ((val*(*)(val* self))((((int64_t)var_9&3)?class_info[((int64_t)var_9&3)]:var_9->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_9); /* item on <var_9:IndexedIterator[Phase]>*/
}
var_phase = var11;
...
{
((void(*)(val* self))((((int64_t)var_9&3)?class_info[((int64_t)var_9&3)]:var_9->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_9); /* next on <var_9:IndexedIterator[Phase]>*/
}
}
BREAK_label: (void)0;
{
((void(*)(val* self))((((int64_t)var_9&3)?class_info[((int64_t)var_9&3)]:var_9->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_9); /* finish on <var_9:IndexedIterator[Phase]>*/
}
var_20 = var_nmodules;
{
var21 = ((val*(*)(val* self))((((int64_t)var_20&3)?class_info[((int64_t)var_20&3)]:var_20->class)->vft[COLOR_core__abstract_collection__Collection__iterator]))(var_20); /* iterator on <var_20:Collection[AModule]>*/
}
var_22 = var21;
for(;;) {
{
var23 = ((short int(*)(val* self))((((int64_t)var_22&3)?class_info[((int64_t)var_22&3)]:var_22->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_22); /* is_ok on <var_22:Iterator[AModule]>*/
}
if (var23){
} else {
goto BREAK_label24;
...
{
var25 = ((val*(*)(val* self))((((int64_t)var_22&3)?class_info[((int64_t)var_22&3)]:var_22->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_22); /* item on <var_22:Iterator[AModule]>*/
}
var_nmodule = var25;
{
...
var_52 = var_phases;
{
var53 = ((val*(*)(val* self))((((int64_t)var_52&3)?class_info[((int64_t)var_52&3)]:var_52->class)->vft[COLOR_core__abstract_collection__Collection__iterator]))(var_52); /* iterator on <var_52:Sequence[Phase]>*/
}
var_54 = var53;
for(;;) {
{
var55 = ((short int(*)(val* self))((((int64_t)var_54&3)?class_info[((int64_t)var_54&3)]:var_54->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_54); /* is_ok on <var_54:IndexedIterator[Phase]>*/
}
if (var55){
} else {
goto BREAK_label56;
...
{
var57 = ((val*(*)(val* self))((((int64_t)var_54&3)?class_info[((int64_t)var_54&3)]:var_54->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_54); /* item on <var_54:IndexedIterator[Phase]>*/
}
var_phase58 = var57;
{
...
for(;;) {
{
var91 = ((short int(*)(val* self))((((int64_t)var_90&3)?class_info[((int64_t)var_90&3)]:var_90->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_90); /* is_ok on <var_90:Iterator[AClassdef]>*/
}
if (var91){
} else {
goto BREAK_label92;
...
{
var93 = ((val*(*)(val* self))((((int64_t)var_90&3)?class_info[((int64_t)var_90&3)]:var_90->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_90); /* item on <var_90:Iterator[AClassdef]>*/
}
var_nclassdef = var93;
{
{ /* Inline phase$Phase$toolcontext (var_phase58) on <var_phase58:Phase> */
...
for(;;) {
{
var112 = ((short int(*)(val* self))((((int64_t)var_111&3)?class_info[((int64_t)var_111&3)]:var_111->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_111); /* is_ok on <var_111:Iterator[APropdef]>*/
}
if (var112){
} else {
goto BREAK_label113;
...
{
var114 = ((val*(*)(val* self))((((int64_t)var_111&3)?class_info[((int64_t)var_111&3)]:var_111->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_111); /* item on <var_111:Iterator[APropdef]>*/
}
var_npropdef = var114;
{
{ /* Inline phase$Phase$toolcontext (var_phase58) on <var_phase58:Phase> */
...
{
((void(*)(val* self))((((int64_t)var_111&3)?class_info[((int64_t)var_111&3)]:var_111->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_111); /* next on <var_111:Iterator[APropdef]>*/
}
}
BREAK_label113: (void)0;
{
((void(*)(val* self))((((int64_t)var_111&3)?class_info[((int64_t)var_111&3)]:var_111->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_111); /* finish on <var_111:Iterator[APropdef]>*/
}
} else {
}
{
((void(*)(val* self))((((int64_t)var_90&3)?class_info[((int64_t)var_90&3)]:var_90->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_90); /* next on <var_90:Iterator[AClassdef]>*/
}
}
BREAK_label92: (void)0;
{
((void(*)(val* self))((((int64_t)var_90&3)?class_info[((int64_t)var_90&3)]:var_90->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_90); /* finish on <var_90:Iterator[AClassdef]>*/
}
{
{ /* Inline toolcontext$ToolContext$error_count (self) on <self:ToolContext> */
...
for(;;) {
{
var137 = ((short int(*)(val* self))((((int64_t)var_136&3)?class_info[((int64_t)var_136&3)]:var_136->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_136); /* is_ok on <var_136:IndexedIterator[AAnnotation]>*/
}
if (var137){
} else {
goto BREAK_label138;
...
{
var139 = ((val*(*)(val* self))((((int64_t)var_136&3)?class_info[((int64_t)var_136&3)]:var_136->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_136); /* item on <var_136:IndexedIterator[AAnnotation]>*/
}
var_na = var139;
{
...
{
((void(*)(val* self))((((int64_t)var_136&3)?class_info[((int64_t)var_136&3)]:var_136->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_136); /* next on <var_136:IndexedIterator[AAnnotation]>*/
}
}
BREAK_label138: (void)0;
{
((void(*)(val* self))((((int64_t)var_136&3)?class_info[((int64_t)var_136&3)]:var_136->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_136); /* finish on <var_136:IndexedIterator[AAnnotation]>*/
}
{
{ /* Inline toolcontext$ToolContext$error_count (self) on <self:ToolContext> */
...
BREAK_label62: (void)0;
{
((void(*)(val* self))((((int64_t)var_54&3)?class_info[((int64_t)var_54&3)]:var_54->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_54); /* next on <var_54:IndexedIterator[Phase]>*/
}
}
BREAK_label56: (void)0;
{
((void(*)(val* self))((((int64_t)var_54&3)?class_info[((int64_t)var_54&3)]:var_54->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_54); /* finish on <var_54:IndexedIterator[Phase]>*/
}
{
...
{
((void(*)(val* self))((((int64_t)var_22&3)?class_info[((int64_t)var_22&3)]:var_22->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_22); /* next on <var_22:Iterator[AModule]>*/
}
}
BREAK_label24: (void)0;
{
((void(*)(val* self))((((int64_t)var_22&3)?class_info[((int64_t)var_22&3)]:var_22->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_22); /* finish on <var_22:Iterator[AModule]>*/
}
var162 = glob_sys;
{
...
var165 = core__time___Sys_get_time___impl(var_for_c_0);
var163 = var165;
goto RET_LABEL164;
RET_LABEL164:(void)0;
}
...
var_ = var_phases;
{
var9 = ((val*(*)(val* self))((((int64_t)var_&3)?class_info[((int64_t)var_&3)]:var_->class)->vft[COLOR_core__abstract_collection__Collection__iterator]))(var_); /* iterator on <var_:Sequence[Phase]>*/
}
var_10 = var9;
for(;;) {
{
var11 = ((short int(*)(val* self))((((int64_t)var_10&3)?class_info[((int64_t)var_10&3)]:var_10->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_10); /* is_ok on <var_10:IndexedIterator[Phase]>*/
}
if (var11){
} else {
goto BREAK_label;
...
{
var12 = ((val*(*)(val* self))((((int64_t)var_10&3)?class_info[((int64_t)var_10&3)]:var_10->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_10); /* item on <var_10:IndexedIterator[Phase]>*/
}
var_phase = var12;
{
...
{
((void(*)(val* self))((((int64_t)var_10&3)?class_info[((int64_t)var_10&3)]:var_10->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_10); /* next on <var_10:IndexedIterator[Phase]>*/
}
}
BREAK_label: (void)0;
{
((void(*)(val* self))((((int64_t)var_10&3)?class_info[((int64_t)var_10&3)]:var_10->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_10); /* finish on <var_10:IndexedIterator[Phase]>*/
}
RET_LABEL:;
}
...
var_other = ((val*)NULL);
{
var14 = ((short int(*)(val* self, val* p0))((((int64_t)var_depends&3)?class_info[((int64_t)var_depends&3)]:var_depends->class)->vft[COLOR_core__kernel__Object___61d_61d]))(var_depends, var_other); /* == on <var_depends:nullable Collection[Phase](Collection[Phase])>*/
}
var15 = !var14;
var12 = var15;
goto RET_LABEL13;
...
var_ = var_depends;
{
var16 = ((val*(*)(val* self))((((int64_t)var_&3)?class_info[((int64_t)var_&3)]:var_->class)->vft[COLOR_core__abstract_collection__Collection__iterator]))(var_); /* iterator on <var_:Collection[Phase]>*/
}
var_17 = var16;
for(;;) {
{
var18 = ((short int(*)(val* self))((((int64_t)var_17&3)?class_info[((int64_t)var_17&3)]:var_17->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_17); /* is_ok on <var_17:Iterator[Phase]>*/
}
if (var18){
} else {
goto BREAK_label;
...
{
var19 = ((val*(*)(val* self))((((int64_t)var_17&3)?class_info[((int64_t)var_17&3)]:var_17->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_17); /* item on <var_17:Iterator[Phase]>*/
}
var_d = var19;
{
{ /* Inline phase$Phase$toolcontext (self) on <self:Phase> */
...
{
((void(*)(val* self))((((int64_t)var_17&3)?class_info[((int64_t)var_17&3)]:var_17->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_17); /* next on <var_17:Iterator[Phase]>*/
}
}
BREAK_label: (void)0;
{
((void(*)(val* self))((((int64_t)var_17&3)?class_info[((int64_t)var_17&3)]:var_17->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_17); /* finish on <var_17:Iterator[Phase]>*/
}
} else {
}
RET_LABEL:;
