...
int64_t core__file___NativeFile_io_close___impl( void* self );
val* NEW_core__NativeArray(int length, const struct type* type);
extern const struct type type_core__NativeArray__core__String;
int64_t core__kernel___Sys_errno___impl( struct nitni_instance * self );
...
int64_t core__file___NativeFile_set_buffering_type___impl( void* self, int64_t buf_length, int64_t mode );
#define COLOR_core___core__FileReader___core__stream__Stream__close 31
...
int64_t core__file___NativeFile_io_read___impl( void* self, char* buf, int64_t len );
...
#define COLOR_core__file__Text__write_native_to 60
#define COLOR_core___core__FileWriter___core__stream__Stream__close 24
int64_t core__file___NativeFile_io_write___impl( void* self, char* buf, int64_t from, int64_t len );
...
#define COLOR_core___core__Stdin___core__kernel__Object__init 32
...
int64_t core__file___Sys_buffer_mode_line___impl( struct nitni_instance * self );
...
#define COLOR_core__stream__Writable__write_to 33
...
#define COLOR_core__file__String__file_extension 98
...
#define COLOR_core__abstract_collection__SequenceRead__last_index_of 37
