...
int64_t core__math___Int____38d(int64_t self, int64_t p0) {
int64_t var /* : Int */;
int64_t var1 /* : Int */;
var1 = self & p0;
var = var1;
...
/* method math$Int$| for (self: Int, Int): Int */
int64_t core__math___Int____124d(int64_t self, int64_t p0) {
int64_t var /* : Int */;
int64_t var1 /* : Int */;
var1 = self | p0;
var = var1;
...
int64_t core__math___Float___is_inf(double self) {
int64_t var /* : Int */;
short int var1 /* : Bool */;
short int var3 /* : Bool */;
short int var4 /* : Bool */;
...
void core__math___Sys___srand_from(val* self, int64_t p0) {
struct nitni_instance* var_for_c_0;
var_for_c_0 = nit_alloc(sizeof(struct nitni_instance));
var_for_c_0->value = self;
