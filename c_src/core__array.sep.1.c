...
int64_t core___core__AbstractArrayRead___core__abstract_collection__Collection__length(val* self) {
int64_t var /* : Int */;
int64_t var1 /* : Int */;
...
/* method array$AbstractArrayRead$length= for (self: AbstractArrayRead[nullable Object], Int) */
void core___core__AbstractArrayRead___length_61d(val* self, int64_t p0) {
...
var_i = 0l;
{
var1 = ((int64_t(*)(val* self))(self->class->vft[COLOR_core__abstract_collection__Collection__length]))(self); /* length on <self:AbstractArrayRead[nullable Object]>*/
}
var_l = var1;
for(;;) {
{
...
if (var2){
{
var6 = ((val*(*)(val* self, int64_t p0))(self->class->vft[COLOR_core__abstract_collection__SequenceRead___91d_93d]))(self, var_i); /* [] on <self:AbstractArrayRead[nullable Object]>*/
}
if (var6 == NULL) {
var7 = (var_item == NULL);
} else {
var8 = ((short int(*)(val* self, val* p0))((((int64_t)var6&3)?class_info[((int64_t)var6&3)]:var6->class)->vft[COLOR_core__kernel__Object___61d_61d]))(var6, var_item); /* == on <var6:nullable Object>*/
var7 = var8;
}
if (var7){
var = 1;
...
int64_t core___core__AbstractArrayRead___core__abstract_collection__Collection__count(val* self, val* p0) {
int64_t var /* : Int */;
val* var_item /* var item: nullable Object */;
...
int64_t core___core__AbstractArrayRead___core__abstract_collection__SequenceRead__last_index_of(val* self, val* p0) {
int64_t var /* : Int */;
val* var_item /* var item: nullable Object */;
int64_t var1 /* : Int */;
int64_t var2 /* : Int */;
...
if (var1){
{
var5 = ((val*(*)(val* self, int64_t p0))(self->class->vft[COLOR_core__abstract_collection__SequenceRead___91d_93d]))(self, var_i); /* [] on <self:AbstractArrayRead[nullable Object]>*/
}
if (var5 == NULL) {
var6 = (var_item == NULL);
} else {
...
var_cmp = var7;
{
var14 = ((val*(*)(val* self, int64_t p0))(self->class->vft[COLOR_core__abstract_collection__SequenceRead___91d_93d]))(self, var_cmp); /* [] on <self:AbstractArrayRead[nullable Object]>*/
}
{
...
void core___core__AbstractArrayRead___copy_to(val* self, int64_t p0, int64_t p1, val* p2, int64_t p3) {
short int var /* : Bool */;
int cltype;
int idtype;
...
int64_t var_new_start /* var new_start: Int */;
short int var1 /* : Bool */;
short int var3 /* : Bool */;
int cltype4;
int idtype5;
...
{
var36 = ((val*(*)(val* self, int64_t p0))(self->class->vft[COLOR_core__abstract_collection__SequenceRead___91d_93d]))(self, var29); /* [] on <self:AbstractArrayRead[nullable Object]>*/
}
{
((void(*)(val* self, int64_t p0, val* p1))(var_dest->class->vft[COLOR_core__abstract_collection__Sequence___91d_93d_61d]))(var_dest, var22, var36); /* []= on <var_dest:AbstractArray[nullable Object]>*/
}
} else {
goto BREAK_label;
}
...
{
var59 = ((val*(*)(val* self, int64_t p0))(self->class->vft[COLOR_core__abstract_collection__SequenceRead___91d_93d]))(self, var52); /* [] on <self:AbstractArrayRead[nullable Object]>*/
}
{
((void(*)(val* self, int64_t p0, val* p1))(var_dest->class->vft[COLOR_core__abstract_collection__Sequence___91d_93d_61d]))(var_dest, var45, var59); /* []= on <var_dest:AbstractArray[nullable Object]>*/
}
{
...
val* core___core__AbstractArrayRead___sub(val* self, int64_t p0, int64_t p1) {
val* var /* : Array[nullable Object] */;
...
var_to = var19;
{
var26 = ((int64_t(*)(val* self))(self->class->vft[COLOR_core__abstract_collection__Collection__length]))(self); /* length on <self:AbstractArrayRead[nullable Object]>*/
}
{
...
if (var27){
{
var34 = ((int64_t(*)(val* self))(self->class->vft[COLOR_core__abstract_collection__Collection__length]))(self); /* length on <self:AbstractArrayRead[nullable Object]>*/
}
var_to = var34;
} else {
}
...
if (var43){
{
var50 = ((val*(*)(val* self, int64_t p0))(self->class->vft[COLOR_core__abstract_collection__SequenceRead___91d_93d]))(self, var_from); /* [] on <self:AbstractArrayRead[nullable Object]>*/
}
{
...
var_r = var3;
{
var4 = ((int64_t(*)(val* self))(self->class->vft[COLOR_core__abstract_collection__Collection__length]))(self); /* length on <self:AbstractArray[nullable Object]>*/
}
{
{ /* Inline kernel$Int$- (var4,1l) on <var4:Int> */
/* Covariant cast for argument 0 (i) <1l:Int> isa OTHER */
...
var_l = var5;
{
((void(*)(val* self, int64_t p0, int64_t p1, val* p2, int64_t p3))(self->class->vft[COLOR_core__array__AbstractArrayRead__copy_to]))(self, 1l, var_l, self, 0l); /* copy_to on <self:AbstractArray[nullable Object]>*/
}
...
var_item = p0;
{
var1 = ((int64_t(*)(val* self))(self->class->vft[COLOR_core__abstract_collection__Collection__length]))(self); /* length on <self:AbstractArray[nullable Object]>*/
}
var_l = var1;
{
...
{
((void(*)(val* self, int64_t p0))(self->class->vft[COLOR_core__array__AbstractArray__enlarge]))(self, var9); /* enlarge on <self:AbstractArray[nullable Object]>*/
}
{
((void(*)(val* self, int64_t p0, int64_t p1, val* p2, int64_t p3))(self->class->vft[COLOR_core__array__AbstractArrayRead__copy_to]))(self, 0l, var_l, self, 1l); /* copy_to on <self:AbstractArray[nullable Object]>*/
}
} else {
}
{
((void(*)(val* self, int64_t p0, val* p1))(self->class->vft[COLOR_core__abstract_collection__Sequence___91d_93d_61d]))(self, 0l, var_item); /* []= on <self:AbstractArray[nullable Object]>*/
}
RET_LABEL:;
}
/* method array$AbstractArray$insert for (self: AbstractArray[nullable Object], nullable Object, Int) */
void core___core__AbstractArray___core__abstract_collection__Sequence__insert(val* self, val* p0, int64_t p1) {
short int var /* : Bool */;
int cltype;
int idtype;
const struct type* type_struct;
...
{
((void(*)(val* self, int64_t p0))(self->class->vft[COLOR_core__array__AbstractArray__enlarge]))(self, var2); /* enlarge on <self:AbstractArray[nullable Object]>*/
}
{
var9 = ((int64_t(*)(val* self))(self->class->vft[COLOR_core__abstract_collection__Collection__length]))(self); /* length on <self:AbstractArray[nullable Object]>*/
}
{
...
{
((void(*)(val* self, int64_t p0, int64_t p1, val* p2, int64_t p3))(self->class->vft[COLOR_core__array__AbstractArrayRead__copy_to]))(self, var_pos, var10, self, var17); /* copy_to on <self:AbstractArray[nullable Object]>*/
}
{
((void(*)(val* self, int64_t p0, val* p1))(self->class->vft[COLOR_core__abstract_collection__Sequence___91d_93d_61d]))(self, var_pos, var_item); /* []= on <self:AbstractArray[nullable Object]>*/
}
RET_LABEL:;
}
/* method array$AbstractArray$insert_all for (self: AbstractArray[nullable Object], Collection[nullable Object], Int) */
void core___core__AbstractArray___core__abstract_collection__Sequence__insert_all(val* self, val* p0, int64_t p1) {
short int var /* : Bool */;
int cltype;
int idtype;
const struct type* type_struct;
...
var_pos = p1;
{
var1 = ((int64_t(*)(val* self))((((int64_t)var_coll&3)?class_info[((int64_t)var_coll&3)]:var_coll->class)->vft[COLOR_core__abstract_collection__Collection__length]))(var_coll); /* length on <var_coll:Collection[nullable Object]>*/
}
var_l = var1;
{
{ /* Inline kernel$Int$== (var_l,0l) on <var_l:Int> */
...
{
var5 = ((int64_t(*)(val* self))(self->class->vft[COLOR_core__abstract_collection__Collection__length]))(self); /* length on <self:AbstractArray[nullable Object]>*/
}
{
...
{
((void(*)(val* self, int64_t p0))(self->class->vft[COLOR_core__array__AbstractArray__enlarge]))(self, var6); /* enlarge on <self:AbstractArray[nullable Object]>*/
}
var_ = self;
...
{
var21 = ((int64_t(*)(val* self))(self->class->vft[COLOR_core__abstract_collection__Collection__length]))(self); /* length on <self:AbstractArray[nullable Object]>*/
}
{
...
{
((void(*)(val* self, int64_t p0, int64_t p1, val* p2, int64_t p3))(self->class->vft[COLOR_core__array__AbstractArrayRead__copy_to]))(self, var_pos, var29, self, var36); /* copy_to on <self:AbstractArray[nullable Object]>*/
}
var_43 = var_coll;
{
var44 = ((val*(*)(val* self))((((int64_t)var_43&3)?class_info[((int64_t)var_43&3)]:var_43->class)->vft[COLOR_core__abstract_collection__Collection__iterator]))(var_43); /* iterator on <var_43:Collection[nullable Object]>*/
}
var_45 = var44;
for(;;) {
{
var46 = ((short int(*)(val* self))((((int64_t)var_45&3)?class_info[((int64_t)var_45&3)]:var_45->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_45); /* is_ok on <var_45:Iterator[nullable Object]>*/
}
if (var46){
} else {
goto BREAK_label;
...
{
var47 = ((val*(*)(val* self))((((int64_t)var_45&3)?class_info[((int64_t)var_45&3)]:var_45->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_45); /* item on <var_45:Iterator[nullable Object]>*/
}
var_c = var47;
{
((void(*)(val* self, int64_t p0, val* p1))(self->class->vft[COLOR_core__abstract_collection__Sequence___91d_93d_61d]))(self, var_pos, var_c); /* []= on <self:AbstractArray[nullable Object]>*/
}
{
{ /* Inline kernel$Int$+ (var_pos,1l) on <var_pos:Int> */
/* Covariant cast for argument 0 (i) <1l:Int> isa OTHER */
...
var_pos = var48;
{
((void(*)(val* self))((((int64_t)var_45&3)?class_info[((int64_t)var_45&3)]:var_45->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_45); /* next on <var_45:Iterator[nullable Object]>*/
}
}
BREAK_label: (void)0;
{
((void(*)(val* self))((((int64_t)var_45&3)?class_info[((int64_t)var_45&3)]:var_45->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_45); /* finish on <var_45:Iterator[nullable Object]>*/
}
RET_LABEL:;
}
...
var_i = p0;
{
var = ((int64_t(*)(val* self))(self->class->vft[COLOR_core__abstract_collection__Collection__length]))(self); /* length on <self:AbstractArray[nullable Object]>*/
}
var_l = var;
{
{ /* Inline kernel$Int$>= (var_i,0l) on <var_i:Int> */
...
{
var34 = ((val*(*)(val* self, int64_t p0))(self->class->vft[COLOR_core__abstract_collection__SequenceRead___91d_93d]))(self, var_j); /* [] on <self:AbstractArray[nullable Object]>*/
}
{
((void(*)(val* self, int64_t p0, val* p1))(self->class->vft[COLOR_core__abstract_collection__Sequence___91d_93d_61d]))(self, var27, var34); /* []= on <self:AbstractArray[nullable Object]>*/
}
{
{ /* Inline kernel$Int$+ (var_j,1l) on <var_j:Int> */
/* Covariant cast for argument 0 (i) <1l:Int> isa OTHER */
...
var = (((int64_t)p1&3)?type_info[((int64_t)p1&3)]:p1->type)->type_table[cltype] == idtype;
}
}
if (unlikely(!var)) {
...
if(cltype57 >= (((int64_t)var_item&3)?type_info[((int64_t)var_item&3)]:var_item->type)->table_size) {
var56 = 0;
} else {
var56 = (((int64_t)var_item&3)?type_info[((int64_t)var_item&3)]:var_item->type)->type_table[cltype57] == idtype58;
}
}
if (unlikely(!var56)) {
var_class_name61 = var_item == NULL ? "null" : (((int64_t)var_item&3)?type_info[((int64_t)var_item&3)]:var_item->type)->name;
...
if(cltype27 >= (((int64_t)var_item&3)?type_info[((int64_t)var_item&3)]:var_item->type)->table_size) {
var26 = 0;
} else {
var26 = (((int64_t)var_item&3)?type_info[((int64_t)var_item&3)]:var_item->type)->type_table[cltype27] == idtype28;
}
}
if (unlikely(!var26)) {
var_class_name31 = var_item == NULL ? "null" : (((int64_t)var_item&3)?type_info[((int64_t)var_item&3)]:var_item->type)->name;
...
var_l = var1;
{
var2 = ((int64_t(*)(val* self))((((int64_t)var_items&3)?class_info[((int64_t)var_items&3)]:var_items->class)->vft[COLOR_core__abstract_collection__Collection__length]))(var_items); /* length on <var_items:Collection[nullable Object]>*/
}
{
...
if(cltype19 >= (((int64_t)var_items&3)?type_info[((int64_t)var_items&3)]:var_items->type)->table_size) {
var18 = 0;
} else {
var18 = (((int64_t)var_items&3)?type_info[((int64_t)var_items&3)]:var_items->type)->type_table[cltype19] == idtype20;
}
if (var18){
var_k = 0l;
for(;;) {
...
if(cltype36 >= (((int64_t)var31&3)?type_info[((int64_t)var31&3)]:var31->type)->table_size) {
var35 = 0;
} else {
var35 = (((int64_t)var31&3)?type_info[((int64_t)var31&3)]:var31->type)->type_table[cltype36] == idtype37;
}
}
if (unlikely(!var35)) {
var_class_name39 = var31 == NULL ? "null" : (((int64_t)var31&3)?type_info[((int64_t)var31&3)]:var31->type)->name;
...
var_ = var_items;
{
var54 = ((val*(*)(val* self))((((int64_t)var_&3)?class_info[((int64_t)var_&3)]:var_->class)->vft[COLOR_core__abstract_collection__Collection__iterator]))(var_); /* iterator on <var_:Collection[nullable Object]>*/
}
var_55 = var54;
for(;;) {
{
var56 = ((short int(*)(val* self))((((int64_t)var_55&3)?class_info[((int64_t)var_55&3)]:var_55->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_55); /* is_ok on <var_55:Iterator[nullable Object]>*/
}
if (var56){
} else {
goto BREAK_label57;
...
{
var58 = ((val*(*)(val* self))((((int64_t)var_55&3)?class_info[((int64_t)var_55&3)]:var_55->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_55); /* item on <var_55:Iterator[nullable Object]>*/
}
var_item = var58;
...
if(cltype62 >= (((int64_t)var_item&3)?type_info[((int64_t)var_item&3)]:var_item->type)->table_size) {
var61 = 0;
} else {
var61 = (((int64_t)var_item&3)?type_info[((int64_t)var_item&3)]:var_item->type)->type_table[cltype62] == idtype63;
}
}
if (unlikely(!var61)) {
var_class_name66 = var_item == NULL ? "null" : (((int64_t)var_item&3)?type_info[((int64_t)var_item&3)]:var_item->type)->name;
...
var_l = var67;
{
((void(*)(val* self))((((int64_t)var_55&3)?class_info[((int64_t)var_55&3)]:var_55->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_55); /* next on <var_55:Iterator[nullable Object]>*/
}
}
BREAK_label57: (void)0;
{
((void(*)(val* self))((((int64_t)var_55&3)?class_info[((int64_t)var_55&3)]:var_55->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_55); /* finish on <var_55:Iterator[nullable Object]>*/
}
}
...
void core___core__Array___AbstractArrayRead__copy_to(val* self, int64_t p0, int64_t p1, val* p2, int64_t p3) {
short int var /* : Bool */;
int cltype;
int idtype;
const struct type* type_struct;
...
const char* var_class_name11;
int64_t var12 /* : Int */;
int64_t var_dest_len /* var dest_len: Int */;
int64_t var13 /* : Int */;
int64_t var15 /* : Int */;
short int var16 /* : Bool */;
short int var18 /* : Bool */;
...
if (var5){
{
((void(*)(val* self, int64_t p0, int64_t p1, val* p2, int64_t p3))(self->class->vft[COLOR_core___core__Array___AbstractArrayRead__copy_to]))(self, p0, p1, p2, p3); /* copy_to on <self:Array[nullable Object]>*/
}
goto RET_LABEL;
} else {
}
...
void core___core__Array___filled_with(val* self, val* p0, int64_t p1) {
short int var /* : Bool */;
int cltype;
int idtype;
const struct type* type_struct;
...
void core___core__Array___with_native(val* self, val* p0, int64_t p1) {
short int var /* : Bool */;
int cltype;
int idtype;
const struct type* type_struct;
...
var32 = ((short int(*)(val* self, val* p0))((((int64_t)var25&3)?class_info[((int64_t)var25&3)]:var25->class)->vft[COLOR_core__kernel__Object___33d_61d]))(var25, var28); /* != on <var25:nullable Object>*/
var31 = var32;
}
if (var31){
var = 0;
...
{
var3 = ((val*(*)(val* self, int64_t p0))(var1->class->vft[COLOR_core__abstract_collection__SequenceRead___91d_93d]))(var1, var2); /* [] on <var1:AbstractArrayRead[nullable Object]>*/
}
var = var3;
goto RET_LABEL;
RET_LABEL:;
...
{
var3 = ((int64_t(*)(val* self))(var2->class->vft[COLOR_core__abstract_collection__Collection__length]))(var2); /* length on <var2:AbstractArrayRead[nullable Object]>*/
}
{
...
int64_t core__array___core__array__ArrayIterator___core__abstract_collection__IndexedIterator__index(val* self) {
int64_t var /* : Int */;
int64_t var1 /* : Int */;
var1 = self->attrs[COLOR_core__array__ArrayIterator___index].l; /* _index on <self:ArrayIterator[nullable Object]> */
var = var1;
...
{
var1 = ((int64_t(*)(val* self))(var->class->vft[COLOR_core__abstract_collection__Collection__length]))(var); /* length on <var:AbstractArrayRead[nullable Object]>*/
}
{
{ /* Inline kernel$Int$- (var1,1l) on <var1:Int> */
/* Covariant cast for argument 0 (i) <1l:Int> isa OTHER */
...
int64_t core___core__ArraySet___core__abstract_collection__Collection__length(val* self) {
int64_t var /* : Int */;
val* var1 /* : Array[nullable Object] */;
int64_t var2 /* : Int */;
int64_t var4 /* : Int */;
...
{
var2 = ((short int(*)(val* self))((((int64_t)var1&3)?class_info[((int64_t)var1&3)]:var1->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var1); /* is_ok on <var1:Iterator[nullable Object]>*/
}
var = var2;
goto RET_LABEL;
RET_LABEL:;
...
{
((void(*)(val* self))((((int64_t)var&3)?class_info[((int64_t)var&3)]:var->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var); /* next on <var:Iterator[nullable Object]>*/
}
RET_LABEL:;
}
...
{
var2 = ((val*(*)(val* self))((((int64_t)var1&3)?class_info[((int64_t)var1&3)]:var1->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var1); /* item on <var1:Iterator[nullable Object]>*/
}
var = var2;
goto RET_LABEL;
RET_LABEL:;
...
var1 = (((int64_t)var_key&3)?type_info[((int64_t)var_key&3)]:var_key->type)->type_table[cltype] == idtype;
}
}
if (unlikely(!var1)) {
...
if(cltype19 >= (((int64_t)var_item&3)?type_info[((int64_t)var_item&3)]:var_item->type)->table_size) {
var18 = 0;
} else {
var18 = (((int64_t)var_item&3)?type_info[((int64_t)var_item&3)]:var_item->type)->type_table[cltype19] == idtype20;
}
}
if (unlikely(!var18)) {
var_class_name23 = var_item == NULL ? "null" : (((int64_t)var_item&3)?type_info[((int64_t)var_item&3)]:var_item->type)->name;
...
var21 = ((short int(*)(val* self, val* p0))((((int64_t)var17&3)?class_info[((int64_t)var17&3)]:var17->class)->vft[COLOR_core__kernel__Object___61d_61d]))(var17, var_key); /* == on <var17:nullable Object>*/
var20 = var21;
}
var3 = var20;
} else {
...
var39 = ((short int(*)(val* self, val* p0))((((int64_t)var35&3)?class_info[((int64_t)var35&3)]:var35->class)->vft[COLOR_core__kernel__Object___61d_61d]))(var35, var_key); /* == on <var35:nullable Object>*/
var38 = var39;
}
if (var38){
...
int64_t core__array___core__array__ArrayMapKeys___core__abstract_collection__Collection__count(val* self, val* p0) {
int64_t var /* : Int */;
...
if(cltype >= (((int64_t)var_k&3)?type_info[((int64_t)var_k&3)]:var_k->type)->table_size) {
var4 = 0;
} else {
var4 = (((int64_t)var_k&3)?type_info[((int64_t)var_k&3)]:var_k->type)->type_table[cltype] == idtype;
}
}
if (unlikely(!var4)) {
var_class_name = var_k == NULL ? "null" : (((int64_t)var_k&3)?type_info[((int64_t)var_k&3)]:var_k->type)->name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "K", var_class_name);
...
int64_t core__array___core__array__ArrayMapKeys___core__abstract_collection__Collection__length(val* self) {
int64_t var /* : Int */;
val* var1 /* : ArrayMap[nullable Object, nullable Object] */;
val* var3 /* : ArrayMap[nullable Object, nullable Object] */;
int64_t var4 /* : Int */;
...
var3 = (((int64_t)var_key&3)?type_info[((int64_t)var_key&3)]:var_key->type)->type_table[cltype] == idtype;
}
}
if (unlikely(!var3)) {
var_class_name = var_key == NULL ? "null" : (((int64_t)var_key&3)?type_info[((int64_t)var_key&3)]:var_key->type)->name;
...
int64_t core__array___core__array__ArrayMapValues___core__abstract_collection__Collection__length(val* self) {
int64_t var /* : Int */;
val* var1 /* : ArrayMap[nullable Object, nullable Object] */;
val* var3 /* : ArrayMap[nullable Object, nullable Object] */;
int64_t var4 /* : Int */;
...
for(;;) {
{
var7 = ((short int(*)(val* self))((((int64_t)var_6&3)?class_info[((int64_t)var_6&3)]:var_6->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_6); /* is_ok on <var_6:IndexedIterator[Couple[nullable Object, nullable Object]]>*/
}
if (var7){
} else {
goto BREAK_label;
...
{
var8 = ((val*(*)(val* self))((((int64_t)var_6&3)?class_info[((int64_t)var_6&3)]:var_6->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_6); /* item on <var_6:IndexedIterator[Couple[nullable Object, nullable Object]]>*/
}
var_i = var8;
{
...
var13 = ((short int(*)(val* self, val* p0))((((int64_t)var9&3)?class_info[((int64_t)var9&3)]:var9->class)->vft[COLOR_core__kernel__Object___61d_61d]))(var9, var_item); /* == on <var9:nullable Object>*/
var12 = var13;
}
if (var12){
var = 1;
...
{
((void(*)(val* self))((((int64_t)var_6&3)?class_info[((int64_t)var_6&3)]:var_6->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_6); /* next on <var_6:IndexedIterator[Couple[nullable Object, nullable Object]]>*/
}
}
BREAK_label: (void)0;
{
((void(*)(val* self))((((int64_t)var_6&3)?class_info[((int64_t)var_6&3)]:var_6->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_6); /* finish on <var_6:IndexedIterator[Couple[nullable Object, nullable Object]]>*/
}
var = 0;
goto RET_LABEL;
RET_LABEL:;
...
int64_t core__array___core__array__ArrayMapValues___core__abstract_collection__Collection__count(val* self, val* p0) {
int64_t var /* : Int */;
val* var_item /* var item: nullable Object */;
...
var24 = ((short int(*)(val* self, val* p0))((((int64_t)var20&3)?class_info[((int64_t)var20&3)]:var20->class)->vft[COLOR_core__kernel__Object___61d_61d]))(var20, var_item); /* == on <var20:nullable Object>*/
var23 = var24;
}
if (var23){
{
...
short int var2 /* : Bool */;
val* var3 /* : nullable Object */;
var1 = NEW_core__Array((((int64_t)self&3)?type_info[((int64_t)self&3)]:self->type)->resolution_table->types[COLOR_core__Array__core__Iterator___35dE]);
{
...
for(;;) {
{
var2 = ((short int(*)(val* self))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(self); /* is_ok on <self:Iterator[nullable Object]>*/
}
if (var2){
{
var3 = ((val*(*)(val* self))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(self); /* item on <self:Iterator[nullable Object]>*/
}
{
...
{
((void(*)(val* self))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(self); /* next on <self:Iterator[nullable Object]>*/
}
} else {
goto BREAK_label;
}
...
BREAK_label: (void)0;
{
((void(*)(val* self))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(self); /* finish on <self:Iterator[nullable Object]>*/
}
var = var_res;
goto RET_LABEL;
RET_LABEL:;
...
int64_t var2 /* : Int */;
val* var_res /* var res: Array[nullable Object] */;
var1 = NEW_core__Array((((int64_t)self&3)?type_info[((int64_t)self&3)]:self->type)->resolution_table->types[COLOR_core__Array__core__Collection___35dE]);
{
var2 = ((int64_t(*)(val* self))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Collection__length]))(self); /* length on <self:Collection[nullable Object]>*/
}
{
...
val* core___core__NativeArray___new(val* self, int64_t p0) {
...
int64_t core___core__NativeArray___length(val* self) {
int64_t var /* : Int */;
int64_t var1 /* : Int */;
...
val* core___core__NativeArray____91d_93d(val* self, int64_t p0) {
val* var /* : nullable Object */;
val* var1 /* : Object */;
...
/* method array$NativeArray$[]= for (self: NativeArray[nullable Object], Int, nullable Object) */
void core___core__NativeArray____91d_93d_61d(val* self, int64_t p0, val* p1) {
short int var /* : Bool */;
int cltype;
int idtype;
const struct type* type_struct;
...
void core___core__NativeArray___copy_to(val* self, val* p0, int64_t p1) {
short int var /* : Bool */;
int cltype;
int idtype;
const struct type* type_struct;
...
void core___core__NativeArray___memmove(val* self, int64_t p0, int64_t p1, val* p2, int64_t p3) {
short int var /* : Bool */;
int cltype;
int idtype;
const struct type* type_struct;
