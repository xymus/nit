...
for(;;) {
{
var2 = ((short int(*)(val* self))((((int64_t)var_1&3)?class_info[((int64_t)var_1&3)]:var_1->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_1); /* is_ok on <var_1:IndexedIterator[MModule]>*/
}
if (var2){
} else {
goto BREAK_label;
...
{
var3 = ((val*(*)(val* self))((((int64_t)var_1&3)?class_info[((int64_t)var_1&3)]:var_1->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_1); /* item on <var_1:IndexedIterator[MModule]>*/
}
var_m = var3;
{
{ /* Inline mmodule$MModule$model (self) on <self:MModule> */
...
{
((void(*)(val* self))((((int64_t)var_1&3)?class_info[((int64_t)var_1&3)]:var_1->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_1); /* next on <var_1:IndexedIterator[MModule]>*/
}
}
BREAK_label: (void)0;
{
((void(*)(val* self))((((int64_t)var_1&3)?class_info[((int64_t)var_1&3)]:var_1->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_1); /* finish on <var_1:IndexedIterator[MModule]>*/
}
RET_LABEL:;
}
...
var77 = core__flat___NativeString___to_s_full(var76, 16l, 16l);
var75 = var77;
varonce74 = var75;
}
...
for(;;) {
{
{ /* Inline model_base$MEntity$is_fictive (var_mmodule) on <var_mmodule:MModule> */
var3 = var_mmodule->attrs[COLOR_nitc__model_base__MEntity___is_fictive].s; /* _is_fictive on <var_mmodule:MModule> */
var1 = var3;
RET_LABEL2:(void)0;
}
}
...
var6 = var_mmodule->attrs[COLOR_nitc__mmodule__MModule___in_importation].val; /* _in_importation on <var_mmodule:MModule> */
if (unlikely(var6 == NULL)) {
if(catchStack.cursor >= 0){
longjmp(catchStack.envs[catchStack.cursor], 1);
}
...
{
var8 = ((val*(*)(val* self))((((int64_t)var7&3)?class_info[((int64_t)var7&3)]:var7->class)->vft[COLOR_core__abstract_collection__Collection__first]))(var7); /* first on <var7:Collection[nullable Object](Collection[MModule])>*/
}
var_mmodule = var8;
} else {
goto BREAK_label;
