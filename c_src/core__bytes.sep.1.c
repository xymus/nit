...
int64_t core___core__Bytes___core__abstract_collection__Collection__length(val* self) {
int64_t var /* : Int */;
int64_t var1 /* : Int */;
...
/* method bytes$Bytes$length= for (self: Bytes, Int) */
void core___core__Bytes___core__array__AbstractArrayRead__length_61d(val* self, int64_t p0) {
self->attrs[COLOR_core__bytes__Bytes___length].l = p0; /* _length on <self:Bytes> */
RET_LABEL:;
}
/* method bytes$Bytes$capacity for (self: Bytes): Int */
int64_t core___core__Bytes___capacity(val* self) {
int64_t var /* : Int */;
int64_t var1 /* : Int */;
...
/* method bytes$Bytes$capacity= for (self: Bytes, Int) */
void core___core__Bytes___capacity_61d(val* self, int64_t p0) {
...
{
((void(*)(val* self, int64_t p0))(self->class->vft[COLOR_core__array__AbstractArrayRead__length_61d]))(self, 0l); /* length= on <self:Bytes>*/
}
{
((void(*)(val* self, int64_t p0))(self->class->vft[COLOR_core__bytes__Bytes__capacity_61d]))(self, 0l); /* capacity= on <self:Bytes>*/
}
{
...
void core___core__Bytes___with_capacity(val* self, int64_t p0) {
...
{
((void(*)(val* self, int64_t p0))(self->class->vft[COLOR_core__bytes__Bytes__capacity_61d]))(self, var_cap); /* capacity= on <self:Bytes>*/
}
{
((void(*)(val* self))(self->class->vft[COLOR_core__kernel__Object__init]))(self); /* init on <self:Bytes>*/
}
...
unsigned char core___core__Bytes___core__abstract_collection__SequenceRead___91d_93d(val* self, int64_t p0) {
...
val* VIRTUAL_core___core__Bytes___core__abstract_collection__SequenceRead___91d_93d(val* self, int64_t p0) {
...
/* method bytes$Bytes$[]= for (self: Bytes, Int, Byte) */
void core___core__Bytes___core__abstract_collection__Sequence___91d_93d_61d(val* self, int64_t p0, unsigned char p1) {
short int var /* : Bool */;
int cltype;
int idtype;
const char* var_class_name;
...
void VIRTUAL_core___core__Bytes___core__abstract_collection__Sequence___91d_93d_61d(val* self, int64_t p0, val* p1) {
unsigned char var /* : Byte */;
...
{
core__flat___NativeString___set_char_at(var11, var14, var_c); /* Direct call flat$NativeString$set_char_at on <var11:NativeString>*/
}
var_ = self;
{
{ /* Inline bytes$Bytes$length (var_) on <var_:Bytes> */
...
if(cltype2 >= (((int64_t)var_arr&3)?type_info[((int64_t)var_arr&3)]:var_arr->type)->table_size) {
var1 = 0;
} else {
var1 = (((int64_t)var_arr&3)?type_info[((int64_t)var_arr&3)]:var_arr->type)->type_table[cltype2] == idtype3;
}
if (var1){
{
...
var_ = var_arr;
{
var10 = ((val*(*)(val* self))((((int64_t)var_&3)?class_info[((int64_t)var_&3)]:var_->class)->vft[COLOR_core__abstract_collection__Collection__iterator]))(var_); /* iterator on <var_:Collection[Byte]>*/
}
var_11 = var10;
for(;;) {
{
var12 = ((short int(*)(val* self))((((int64_t)var_11&3)?class_info[((int64_t)var_11&3)]:var_11->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_11); /* is_ok on <var_11:Iterator[Byte]>*/
}
if (var12){
} else {
goto BREAK_label;
...
{
var13 = ((val*(*)(val* self))((((int64_t)var_11&3)?class_info[((int64_t)var_11&3)]:var_11->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_11); /* item on <var_11:Iterator[Byte]>*/
}
...
{
((void(*)(val* self))((((int64_t)var_11&3)?class_info[((int64_t)var_11&3)]:var_11->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_11); /* next on <var_11:Iterator[Byte]>*/
}
}
BREAK_label: (void)0;
{
((void(*)(val* self))((((int64_t)var_11&3)?class_info[((int64_t)var_11&3)]:var_11->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_11); /* finish on <var_11:Iterator[Byte]>*/
}
}
RET_LABEL:;
}
...
{
{ /* Inline native$NativeString$copy_to (var8,var_nns,var11,0l,0l) on <var8:NativeString> */
...
void core___core__Bytes___append_ns(val* self, char* p0, int64_t p1) {
char* var_ns /* var ns: NativeString */;
int64_t var_ln /* var ln: Int */;
short int var /* : Bool */;
short int var2 /* : Bool */;
...
void core___core__Bytes___append_ns_from(val* self, char* p0, int64_t p1, int64_t p2) {
char* var_ns /* var ns: NativeString */;
int64_t var_ln /* var ln: Int */;
...
void core___core__Bytes___core__array__AbstractArray__enlarge(val* self, int64_t p0) {
int64_t var_sz /* var sz: Int */;
int64_t var /* : Int */;
int64_t var2 /* : Int */;
short int var3 /* : Bool */;
short int var5 /* : Bool */;
...
{
{ /* Inline native$NativeString$copy_to (var44,var_ns,var47,0l,0l) on <var44:NativeString> */
...
{
{ /* Inline kernel$Object$!= (var_r,var9) on <var_r:String> */
var14 = BOX_core__NativeString(var9); /* autobox from NativeString to nullable Object */
var_other = var14;
{
var15 = ((short int(*)(val* self, val* p0))(var_r->class->vft[COLOR_core__kernel__Object___61d_61d]))(var_r, var_other); /* == on <var_r:String>*/
}
var16 = !var15;
var12 = var16;
goto RET_LABEL13;
...
int64_t core__bytes___core__bytes__BytesIterator___core__abstract_collection__IndexedIterator__index(val* self) {
int64_t var /* : Int */;
int64_t var1 /* : Int */;
...
/* method bytes$BytesIterator$index= for (self: BytesIterator, Int) */
void core__bytes___core__bytes__BytesIterator___index_61d(val* self, int64_t p0) {
...
int64_t core__bytes___core__bytes__BytesIterator___max(val* self) {
int64_t var /* : Int */;
int64_t var1 /* : Int */;
...
/* method bytes$BytesIterator$max= for (self: BytesIterator, Int) */
void core__bytes___core__bytes__BytesIterator___max_61d(val* self, int64_t p0) {
...
{
((void(*)(val* self, int64_t p0))(self->class->vft[COLOR_core__bytes__BytesIterator__index_61d]))(self, 0l); /* index= on <self:BytesIterator>*/
}
{
((void(*)(val* self, int64_t p0))(self->class->vft[COLOR_core__bytes__BytesIterator__max_61d]))(self, var3); /* max= on <self:BytesIterator>*/
}
{
...
{
var2 = ((int64_t(*)(val* self))(self->class->vft[COLOR_core__abstract_text__Text__byte_length]))(self); /* byte_length on <self:Text>*/
}
{
...
if (var4){
{
var8 = ((uint32_t(*)(val* self, int64_t p0))(self->class->vft[COLOR_core__abstract_text__Text___91d_93d]))(self, var_i); /* [] on <self:Text>*/
}
var_c = var8;
var9 = !var_was_slash;
if (var9){
...
{
var46 = ((val*(*)(val* self, int64_t p0, int64_t p1))(self->class->vft[COLOR_core__abstract_text__Text__substring]))(self, var39, 2l); /* substring on <self:Text>*/
}
var_hx = var46;
{
...
if (var47){
{
var48 = ((int64_t(*)(val* self, val* p0, val* p1))(var_hx->class->vft[COLOR_core__abstract_text__Text__to_hex]))(var_hx, ((val*)NULL), ((val*)NULL)); /* to_hex on <var_hx:Text>*/
}
{
...
{
var74 = ((val*(*)(val* self, int64_t p0, int64_t p1))(self->class->vft[COLOR_core__abstract_text__Text__substring]))(self, var67, 6l); /* substring on <self:Text>*/
}
var_hx75 = var74;
{
...
if (var76){
{
var77 = ((int64_t(*)(val* self, val* p0, val* p1))(var_hx75->class->vft[COLOR_core__abstract_text__Text__to_hex]))(var_hx75, ((val*)NULL), ((val*)NULL)); /* to_hex on <var_hx75:Text>*/
}
{
