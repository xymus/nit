...
int64_t core__fixed_ints___Int8_to_s_len___impl( int8_t self );
void core__fixed_ints___Int8_native_to_s___impl( int8_t self, char* nstr, int64_t strlen );
...
int64_t core__fixed_ints___Int16_to_s_len___impl( int16_t self );
void core__fixed_ints___Int16_native_to_s___impl( int16_t self, char* nstr, int64_t strlen );
...
int64_t core__fixed_ints___UInt16_to_s_len___impl( uint16_t self );
void core__fixed_ints___UInt16_native_to_s___impl( uint16_t self, char* nstr, int64_t strlen );
...
int64_t core__fixed_ints___Int32_to_s_len___impl( int32_t self );
void core__fixed_ints___Int32_native_to_s___impl( int32_t self, char* nstr, int64_t strlen );
...
int64_t core__fixed_ints___UInt32_to_s_len___impl( uint32_t self );
void core__fixed_ints___UInt32_native_to_s___impl( uint32_t self, char* nstr, int64_t strlen );
