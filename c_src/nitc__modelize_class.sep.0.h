...
#define COLOR_nitc__modelize_class__AClasskind__mkind 34
...
#define COLOR_nitc__modelize_class__AClassdef___mclass 4
...
#define COLOR_nitc__modelize_class__AFormaldef___bound 4
