...
for(;;) {
{
var58 = ((short int(*)(val* self))((((int64_t)var_57&3)?class_info[((int64_t)var_57&3)]:var_57->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_57); /* is_ok on <var_57:IndexedIterator[String]>*/
}
if (var58){
} else {
goto BREAK_label;
...
{
var59 = ((val*(*)(val* self))((((int64_t)var_57&3)?class_info[((int64_t)var_57&3)]:var_57->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_57); /* item on <var_57:IndexedIterator[String]>*/
}
var_define = var59;
{
var61 = (val*)((int64_t)('=')<<2|2);
...
var_other52 = ((val*)NULL);
{
var167 = ((short int(*)(val* self, val* p0))(var_val->class->vft[COLOR_core__kernel__Object___61d_61d]))(var_val, var_other52); /* == on <var_val:nullable Object(String)>*/
}
var168 = !var167;
var165 = var168;
goto RET_LABEL166;
...
var_other52 = ((val*)NULL);
{
var195 = ((short int(*)(val* self, val* p0))(var_val->class->vft[COLOR_core__kernel__Object___61d_61d]))(var_val, var_other52); /* == on <var_val:nullable Object(String)>*/
}
var196 = !var195;
var193 = var196;
goto RET_LABEL194;
...
{
((void(*)(val* self))((((int64_t)var_57&3)?class_info[((int64_t)var_57&3)]:var_57->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_57); /* next on <var_57:IndexedIterator[String]>*/
}
}
BREAK_label: (void)0;
{
((void(*)(val* self))((((int64_t)var_57&3)?class_info[((int64_t)var_57&3)]:var_57->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_57); /* finish on <var_57:IndexedIterator[String]>*/
}
{
