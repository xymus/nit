...
varonce = var4;
{
core___core__FileWriter___core__stream__Writer__write(var3, var30); /* Direct call file$FileWriter$write on <var3:Writer>*/
}
RET_LABEL:;
}
...
int64_t nitc___nitc__ANodes___core__abstract_collection__Collection__length(val* self) {
int64_t var /* : Int */;
val* var1 /* : Array[ANode] */;
val* var3 /* : Array[ANode] */;
int64_t var4 /* : Int */;
...
val* nitc___nitc__ANodes___core__abstract_collection__SequenceRead___91d_93d(val* self, int64_t p0) {
val* var /* : ANode */;
...
/* method parser_nodes$ANodes$[]= for (self: ANodes[ANode], Int, ANode) */
void nitc___nitc__ANodes___core__abstract_collection__Sequence___91d_93d_61d(val* self, int64_t p0, val* p1) {
short int var /* : Bool */;
int cltype;
int idtype;
const struct type* type_struct;
...
void nitc___nitc__ANodes___core__abstract_collection__Sequence__remove_at(val* self, int64_t p0) {
int64_t var_index /* var index: Int */;
val* var /* : Array[ANode] */;
val* var2 /* : Array[ANode] */;
...
var_ = var_nodes;
{
var3 = ((val*(*)(val* self))((((int64_t)var_&3)?class_info[((int64_t)var_&3)]:var_->class)->vft[COLOR_core__abstract_collection__Collection__iterator]))(var_); /* iterator on <var_:Collection[Object]>*/
}
var_4 = var3;
for(;;) {
{
var5 = ((short int(*)(val* self))((((int64_t)var_4&3)?class_info[((int64_t)var_4&3)]:var_4->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_4); /* is_ok on <var_4:Iterator[Object]>*/
}
if (var5){
} else {
goto BREAK_label;
...
{
var6 = ((val*(*)(val* self))((((int64_t)var_4&3)?class_info[((int64_t)var_4&3)]:var_4->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_4); /* item on <var_4:Iterator[Object]>*/
}
var_n = var6;
/* <var_n:Object> isa E */
type_struct = self->type->resolution_table->types[COLOR_nitc__ANodes___35dE];
cltype = type_struct->color;
idtype = type_struct->id;
if(cltype >= (((int64_t)var_n&3)?type_info[((int64_t)var_n&3)]:var_n->type)->table_size) {
var7 = 0;
} else {
var7 = (((int64_t)var_n&3)?type_info[((int64_t)var_n&3)]:var_n->type)->type_table[cltype] == idtype;
}
if (unlikely(!var7)) {
if(catchStack.cursor >= 0){
longjmp(catchStack.envs[catchStack.cursor], 1);
...
{
((void(*)(val* self))((((int64_t)var_4&3)?class_info[((int64_t)var_4&3)]:var_4->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_4); /* next on <var_4:Iterator[Object]>*/
}
}
BREAK_label: (void)0;
{
((void(*)(val* self))((((int64_t)var_4&3)?class_info[((int64_t)var_4&3)]:var_4->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_4); /* finish on <var_4:Iterator[Object]>*/
}
RET_LABEL:;
}
...
for(;;) {
{
var2 = ((short int(*)(val* self))((((int64_t)var_1&3)?class_info[((int64_t)var_1&3)]:var_1->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_1); /* is_ok on <var_1:Iterator[ANode]>*/
}
if (var2){
} else {
goto BREAK_label;
...
{
var3 = ((val*(*)(val* self))((((int64_t)var_1&3)?class_info[((int64_t)var_1&3)]:var_1->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_1); /* item on <var_1:Iterator[ANode]>*/
}
var_n = var3;
{
...
{
((void(*)(val* self))((((int64_t)var_1&3)?class_info[((int64_t)var_1&3)]:var_1->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_1); /* next on <var_1:Iterator[ANode]>*/
}
}
BREAK_label: (void)0;
{
((void(*)(val* self))((((int64_t)var_1&3)?class_info[((int64_t)var_1&3)]:var_1->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_1); /* finish on <var_1:Iterator[ANode]>*/
}
RET_LABEL:;
}
...
for(;;) {
{
var15 = ((short int(*)(val* self))((((int64_t)var_14&3)?class_info[((int64_t)var_14&3)]:var_14->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_14); /* is_ok on <var_14:Iterator[AAnnotation]>*/
}
if (var15){
} else {
goto BREAK_label;
...
{
var16 = ((val*(*)(val* self))((((int64_t)var_14&3)?class_info[((int64_t)var_14&3)]:var_14->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_14); /* item on <var_14:Iterator[AAnnotation]>*/
}
var_na = var16;
{
...
{
((void(*)(val* self))((((int64_t)var_14&3)?class_info[((int64_t)var_14&3)]:var_14->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_14); /* next on <var_14:Iterator[AAnnotation]>*/
}
}
BREAK_label: (void)0;
{
((void(*)(val* self))((((int64_t)var_14&3)?class_info[((int64_t)var_14&3)]:var_14->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_14); /* finish on <var_14:Iterator[AAnnotation]>*/
}
} else {
}
...
for(;;) {
{
var30 = ((short int(*)(val* self))((((int64_t)var_29&3)?class_info[((int64_t)var_29&3)]:var_29->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_29); /* is_ok on <var_29:Iterator[APropdef]>*/
}
if (var30){
} else {
goto BREAK_label31;
...
{
var32 = ((val*(*)(val* self))((((int64_t)var_29&3)?class_info[((int64_t)var_29&3)]:var_29->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_29); /* item on <var_29:Iterator[APropdef]>*/
}
var_na33 = var32;
...
{
((void(*)(val* self))((((int64_t)var_29&3)?class_info[((int64_t)var_29&3)]:var_29->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_29); /* next on <var_29:Iterator[APropdef]>*/
}
}
BREAK_label31: (void)0;
{
((void(*)(val* self))((((int64_t)var_29&3)?class_info[((int64_t)var_29&3)]:var_29->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_29); /* finish on <var_29:Iterator[APropdef]>*/
}
} else {
}
var = var_res;
...
var2 = "end of line";
var3 = core__flat___NativeString___to_s_full(var2, 11l, 11l);
var1 = var3;
varonce = var1;
}
var = var1;
...
var4 = "literal value \'";
var5 = core__flat___NativeString___to_s_full(var4, 15l, 15l);
var3 = var5;
varonce2 = var3;
}
((struct instance_core__NativeArray*)var1)->values[0]=var3;
...
for(;;) {
{
var8 = ((short int(*)(val* self))((((int64_t)var_7&3)?class_info[((int64_t)var_7&3)]:var_7->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_7); /* is_ok on <var_7:Iterator[APropdef]>*/
}
if (var8){
} else {
goto BREAK_label;
...
{
var9 = ((val*(*)(val* self))((((int64_t)var_7&3)?class_info[((int64_t)var_7&3)]:var_7->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_7); /* item on <var_7:Iterator[APropdef]>*/
}
var_d = var9;
...
{
((void(*)(val* self))((((int64_t)var_7&3)?class_info[((int64_t)var_7&3)]:var_7->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_7); /* next on <var_7:Iterator[APropdef]>*/
}
}
BREAK_label: (void)0;
{
((void(*)(val* self))((((int64_t)var_7&3)?class_info[((int64_t)var_7&3)]:var_7->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_7); /* finish on <var_7:Iterator[APropdef]>*/
}
var = var_;
goto RET_LABEL;
RET_LABEL:;
