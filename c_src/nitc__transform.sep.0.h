...
#define COLOR_nitc__transform__ToolContext___opt_no_shortcut_range 47
extern const char FILE_nitc__transform[];
#define COLOR_nitc__transform___ToolContext___core__kernel__Object__init 147
...
val* nitc___nitc__ASTBuilder___make_int(val* self, int64_t p0);
