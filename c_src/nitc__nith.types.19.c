...
-1, /* empty */
-1, /* empty */
1572, /* NativeArray[nullable HashMapNode[MType, Array[nullable MType]]] */
1583, /* NativeArray[nullable HashMapNode[MClassType, Array[nullable MType]]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1589, /* HashMapNode[MClass, Array[nullable MPropDef]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1590, /* NativeArray[nullable HashMapNode[MClass, Array[nullable MPropDef]]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1600, /* HashMapNode[MClass, Array[nullable MProperty]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1601, /* NativeArray[nullable HashMapNode[MClass, Array[nullable MProperty]]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1611, /* HashMapNode[String, String] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1612, /* NativeArray[nullable HashMapNode[String, String]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1622, /* NativeArray[nullable HashMapNode[String, ANode]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
