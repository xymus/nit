...
int64_t ordered_tree___ordered_tree__OrderedTree___core__abstract_collection__Collection__length(val* self) {
int64_t var /* : Int */;
val* var1 /* : HashMap[Object, nullable Object] */;
...
if (unlikely(!var1)) {
var_class_name5 = p1 == NULL ? "null" : (((int64_t)p1&3)?type_info[((int64_t)p1&3)]:p1->type)->name;
...
if (0) {
var10 = ((short int(*)(val* self, val* p0))((((int64_t)var_p&3)?class_info[((int64_t)var_p&3)]:var_p->class)->vft[COLOR_core__kernel__Object___61d_61d]))(var_p, ((val*)NULL)); /* == on <var_p:nullable Object>*/
var9 = var10;
}
if (var9){
{
...
if (0) {
var6 = ((short int(*)(val* self, val* p0))((((int64_t)var_old_parent&3)?class_info[((int64_t)var_old_parent&3)]:var_old_parent->class)->vft[COLOR_core__kernel__Object___33d_61d]))(var_old_parent, ((val*)NULL)); /* != on <var_old_parent:nullable Object>*/
var5 = var6;
}
if (var5){
{
...
{
((void(*)(val* self, val* p0))((((int64_t)var15&3)?class_info[((int64_t)var15&3)]:var15->class)->vft[COLOR_core__abstract_collection__RemovableCollection__remove]))(var15, var_old_parent); /* remove on <var15:RemovableCollection[nullable Object](RemovableCollection[Object])>*/
}
} else {
}
} else {
...
for(;;) {
{
var5 = ((short int(*)(val* self))((((int64_t)var_4&3)?class_info[((int64_t)var_4&3)]:var_4->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_4); /* is_ok on <var_4:IndexedIterator[Object]>*/
}
if (var5){
} else {
goto BREAK_label;
...
{
var6 = ((val*(*)(val* self))((((int64_t)var_4&3)?class_info[((int64_t)var_4&3)]:var_4->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_4); /* item on <var_4:IndexedIterator[Object]>*/
}
var_r = var6;
{
...
{
((void(*)(val* self))((((int64_t)var_4&3)?class_info[((int64_t)var_4&3)]:var_4->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_4); /* next on <var_4:IndexedIterator[Object]>*/
}
}
BREAK_label: (void)0;
{
((void(*)(val* self))((((int64_t)var_4&3)?class_info[((int64_t)var_4&3)]:var_4->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_4); /* finish on <var_4:IndexedIterator[Object]>*/
}
RET_LABEL:;
}
...
var_e2 = var15;
{
var16 = ((short int(*)(val* self, val* p0))((((int64_t)var_e2&3)?class_info[((int64_t)var_e2&3)]:var_e2->class)->vft[COLOR_core__kernel__Object___33d_61d]))(var_e2, var_last); /* != on <var_e2:Object>*/
}
if (var16){
...
{
var32 = ((val*(*)(val* self, val* p0))(var_prefix->class->vft[COLOR_core__abstract_text__Text___43d]))(var_prefix, var29); /* + on <var_prefix:String>*/
}
{
...
{
var49 = ((val*(*)(val* self, val* p0))(var_prefix->class->vft[COLOR_core__abstract_text__Text___43d]))(var_prefix, var46); /* + on <var_prefix:String>*/
}
{
...
var_ = var6;
{
var7 = ((val*(*)(val* self))((((int64_t)var_&3)?class_info[((int64_t)var_&3)]:var_->class)->vft[COLOR_core__abstract_collection__Collection__iterator]))(var_); /* iterator on <var_:RemovableCollection[Array[Object]]>*/
}
var_8 = var7;
for(;;) {
{
var9 = ((short int(*)(val* self))((((int64_t)var_8&3)?class_info[((int64_t)var_8&3)]:var_8->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_8); /* is_ok on <var_8:Iterator[Array[Object]]>*/
}
if (var9){
} else {
goto BREAK_label;
...
{
var10 = ((val*(*)(val* self))((((int64_t)var_8&3)?class_info[((int64_t)var_8&3)]:var_8->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_8); /* item on <var_8:Iterator[Array[Object]]>*/
}
var_a = var10;
{
...
{
((void(*)(val* self))((((int64_t)var_8&3)?class_info[((int64_t)var_8&3)]:var_8->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_8); /* next on <var_8:Iterator[Array[Object]]>*/
}
}
BREAK_label: (void)0;
{
((void(*)(val* self))((((int64_t)var_8&3)?class_info[((int64_t)var_8&3)]:var_8->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_8); /* finish on <var_8:Iterator[Array[Object]]>*/
}
RET_LABEL:;
}
...
var_e = p0;
{
var2 = ((val*(*)(val* self))((((int64_t)var_e&3)?class_info[((int64_t)var_e&3)]:var_e->class)->vft[COLOR_core__abstract_text__Object__to_s]))(var_e); /* to_s on <var_e:Object>*/
}
var = var2;
goto RET_LABEL;
RET_LABEL:;
...
for(;;) {
{
var16 = ((short int(*)(val* self))((((int64_t)var_15&3)?class_info[((int64_t)var_15&3)]:var_15->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_15); /* is_ok on <var_15:IndexedIterator[Object]>*/
}
if (var16){
} else {
goto BREAK_label;
...
{
var17 = ((val*(*)(val* self))((((int64_t)var_15&3)?class_info[((int64_t)var_15&3)]:var_15->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_15); /* item on <var_15:IndexedIterator[Object]>*/
}
var_e2 = var17;
{
...
{
((void(*)(val* self))((((int64_t)var_15&3)?class_info[((int64_t)var_15&3)]:var_15->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_15); /* next on <var_15:IndexedIterator[Object]>*/
}
}
BREAK_label: (void)0;
{
((void(*)(val* self))((((int64_t)var_15&3)?class_info[((int64_t)var_15&3)]:var_15->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_15); /* finish on <var_15:IndexedIterator[Object]>*/
}
} else {
}
RET_LABEL:;
...
int64_t ordered_tree___ordered_tree__OrderedTree___core__kernel__Object__hash(val* self) {
int64_t var /* : Int */;
val* var1 /* : Array[Object] */;
val* var3 /* : Array[Object] */;
int64_t var4 /* : Int */;
...
for(;;) {
{
var11 = ((short int(*)(val* self))((((int64_t)var_10&3)?class_info[((int64_t)var_10&3)]:var_10->class)->vft[COLOR_core__abstract_collection__MapIterator__is_ok]))(var_10); /* is_ok on <var_10:MapIterator[Object, Array[Object]]>*/
}
if (var11){
} else {
goto BREAK_label;
...
{
var12 = ((val*(*)(val* self))((((int64_t)var_10&3)?class_info[((int64_t)var_10&3)]:var_10->class)->vft[COLOR_core__abstract_collection__MapIterator__key]))(var_10); /* key on <var_10:MapIterator[Object, Array[Object]]>*/
}
var_p = var12;
{
var13 = ((val*(*)(val* self))((((int64_t)var_10&3)?class_info[((int64_t)var_10&3)]:var_10->class)->vft[COLOR_core__abstract_collection__MapIterator__item]))(var_10); /* item on <var_10:MapIterator[Object, Array[Object]]>*/
}
var_es = var13;
{
...
{
((void(*)(val* self))((((int64_t)var_10&3)?class_info[((int64_t)var_10&3)]:var_10->class)->vft[COLOR_core__abstract_collection__MapIterator__next]))(var_10); /* next on <var_10:MapIterator[Object, Array[Object]]>*/
}
}
BREAK_label: (void)0;
{
...
{
var6 = ((val*(*)(val* self))((((int64_t)var5&3)?class_info[((int64_t)var5&3)]:var5->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var5); /* item on <var5:nullable Object(Iterator[Object])>*/
}
var = var6;
goto RET_LABEL;
RET_LABEL:;
...
{
((void(*)(val* self))((((int64_t)var24&3)?class_info[((int64_t)var24&3)]:var24->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var24); /* next on <var24:nullable Object(Iterator[Object])>*/
}
for(;;) {
{
...
{
var31 = ((short int(*)(val* self))((((int64_t)var30&3)?class_info[((int64_t)var30&3)]:var30->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var30); /* is_ok on <var30:nullable Object(Iterator[Object])>*/
}
var32 = !var31;
var25 = var32;
} else {
...
{
var44 = ((short int(*)(val* self))((((int64_t)var43&3)?class_info[((int64_t)var43&3)]:var43->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var43); /* is_ok on <var43:nullable Object(Iterator[Object])>*/
}
var37 = var44;
} else {
var37 = var_39;
...
{
((void(*)(val* self))((((int64_t)var48&3)?class_info[((int64_t)var48&3)]:var48->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var48); /* next on <var48:nullable Object(Iterator[Object])>*/
}
} else {
}
} else {
