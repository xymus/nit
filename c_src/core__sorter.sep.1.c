...
type_struct = (((int64_t)self&3)?type_info[((int64_t)self&3)]:self->type)->resolution_table->types[COLOR_core__Array__core__sorter__Comparator__COMPARED];
...
void core___core__Comparator___sub_sort(val* self, val* p0, int64_t p1, int64_t p2) {
short int var /* : Bool */;
int cltype;
int idtype;
const struct type* type_struct;
...
void core___core__Comparator___quick_sort(val* self, val* p0, int64_t p1, int64_t p2) {
short int var /* : Bool */;
int cltype;
int idtype;
const struct type* type_struct;
...
{
var18 = ((int64_t(*)(val* self, val* p0, val* p1))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__sorter__Comparator__compare]))(self, var17, var_pivot); /* compare on <self:Comparator>*/
}
{
...
{
var43 = ((int64_t(*)(val* self, val* p0, val* p1))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__sorter__Comparator__compare]))(self, var42, var_pivot); /* compare on <self:Comparator>*/
}
{
...
void core___core__Comparator___bubble_sort(val* self, val* p0, int64_t p1, int64_t p2) {
short int var /* : Bool */;
int cltype;
int idtype;
const struct type* type_struct;
...
{
var17 = ((int64_t(*)(val* self, val* p0, val* p1))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__sorter__Comparator__compare]))(self, var_min_v, var16); /* compare on <self:Comparator>*/
}
{
...
int64_t core___core__DefaultComparator___Comparator__compare(val* self, val* p0, val* p1) {
int64_t var /* : Int */;
short int var1 /* : Bool */;
int cltype;
int idtype;
...
var_b = p1;
{
var7 = ((int64_t(*)(val* self, val* p0))((((int64_t)var_a&3)?class_info[((int64_t)var_a&3)]:var_a->class)->vft[COLOR_core__kernel__Comparable___60d_61d_62d]))(var_a, var_b); /* <=> on <var_a:Comparable>*/
}
var = var7;
goto RET_LABEL;
RET_LABEL:;
