...
#define COLOR_nitc___nitc__MVisibility___core__kernel__Object__init 22
...
#define COLOR_nitc__model_base__MVisibility__to_s_61d 19
#define COLOR_nitc__model_base__MVisibility__level_61d 20
