...
for(;;) {
{
var30 = ((short int(*)(val* self))((((int64_t)var_29&3)?class_info[((int64_t)var_29&3)]:var_29->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_29); /* is_ok on <var_29:IndexedIterator[ExternFile]>*/
}
if (var30){
} else {
goto BREAK_label;
...
{
var31 = ((val*(*)(val* self))((((int64_t)var_29&3)?class_info[((int64_t)var_29&3)]:var_29->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_29); /* item on <var_29:IndexedIterator[ExternFile]>*/
}
var_file = var31;
{
{ /* Inline abstract_compiler$AbstractCompilerVisitor$compiler (var_v) on <var_v:AbstractCompilerVisitor> */
...
{
((void(*)(val* self))((((int64_t)var_29&3)?class_info[((int64_t)var_29&3)]:var_29->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_29); /* next on <var_29:IndexedIterator[ExternFile]>*/
}
}
BREAK_label: (void)0;
{
((void(*)(val* self))((((int64_t)var_29&3)?class_info[((int64_t)var_29&3)]:var_29->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_29); /* finish on <var_29:IndexedIterator[ExternFile]>*/
}
{
...
for(;;) {
{
var107 = ((short int(*)(val* self))((((int64_t)var_106&3)?class_info[((int64_t)var_106&3)]:var_106->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_106); /* is_ok on <var_106:IndexedIterator[String]>*/
}
if (var107){
} else {
goto BREAK_label108;
...
{
var109 = ((val*(*)(val* self))((((int64_t)var_106&3)?class_info[((int64_t)var_106&3)]:var_106->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_106); /* item on <var_106:IndexedIterator[String]>*/
}
var_file110 = var109;
...
{
((void(*)(val* self))((((int64_t)var_106&3)?class_info[((int64_t)var_106&3)]:var_106->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_106); /* next on <var_106:IndexedIterator[String]>*/
}
}
BREAK_label108: (void)0;
{
((void(*)(val* self))((((int64_t)var_106&3)?class_info[((int64_t)var_106&3)]:var_106->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_106); /* finish on <var_106:IndexedIterator[String]>*/
}
{
...
{
var8 = ((short int(*)(val* self, val* p0))((((int64_t)var4&3)?class_info[((int64_t)var4&3)]:var4->class)->vft[COLOR_core__abstract_collection__Collection__has]))(var4, var5); /* has on <var4:RemovableCollection[nullable Object](RemovableCollection[String])>*/
}
var9 = !var8;
if (var9){
var = ((val*)NULL);
