...
-1, /* empty */
-1, /* empty */
2069, /* HashMapNode[EscapeMark, String] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
2070, /* NativeArray[nullable HashMapNode[EscapeMark, String]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
2080, /* HashMapNode[MClass, Array[MType]] */
-1, /* empty */
2097, /* HashMapNode[MClass, Array[nullable MType]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
2081, /* NativeArray[nullable HashMapNode[MClass, Array[MType]]] */
-1, /* empty */
2098, /* NativeArray[nullable HashMapNode[MClass, Array[nullable MType]]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
2090, /* HashMapNode[MClass, Set[MType]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
2091, /* NativeArray[nullable HashMapNode[MClass, Set[MType]]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
