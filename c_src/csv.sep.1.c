...
int64_t var1 /* : Int */;
int64_t var_add_sp /* var add_sp: Int */;
short int var2 /* : Bool */;
short int var4 /* : Bool */;
val* var5 /* : String */;
...
{
var8 = ((int64_t(*)(val* self))(self->class->vft[COLOR_core__abstract_text__Text__byte_length]))(self); /* byte_length on <self:Text>*/
}
{
...
{
var22 = ((uint32_t(*)(val* self, int64_t p0))(self->class->vft[COLOR_core__abstract_text__Text___91d_93d]))(self, var_i); /* [] on <self:Text>*/
}
var_c = var22;
{
...
int64_t csv___core__Text___chars_to_escape_csv(val* self, uint32_t p0, uint32_t p1, val* p2) {
int64_t var /* : Int */;
uint32_t var_sep_char /* var sep_char: Char */;
uint32_t var_delim_char /* var delim_char: Char */;
val* var_eol /* var eol: String */;
int64_t var_more_ln /* var more_ln: Int */;
int64_t var1 /* : Int */;
...
if (var3){
{
var7 = ((uint32_t(*)(val* self, int64_t p0))(self->class->vft[COLOR_core__abstract_text__Text___91d_93d]))(self, var_i); /* [] on <self:Text>*/
}
var_c = var7;
{
{ /* Inline kernel$Char$== (var_c,var_delim_char) on <var_c:Char> */
...
var_j = 1l;
{
var21 = ((int64_t(*)(val* self))(var_eol->class->vft[COLOR_core__abstract_text__Text__length]))(var_eol); /* length on <var_eol:String>*/
}
var_ = var21;
for(;;) {
{
...
var_i = var29;
{
var36 = ((uint32_t(*)(val* self, int64_t p0))(self->class->vft[COLOR_core__abstract_text__Text___91d_93d]))(self, var_i); /* [] on <self:Text>*/
}
var_c = var36;
{
var37 = ((uint32_t(*)(val* self, int64_t p0))(var_eol->class->vft[COLOR_core__abstract_text__Text___91d_93d]))(var_eol, var_j); /* [] on <var_eol:String>*/
}
{
...
for(;;) {
{
var6 = ((short int(*)(val* self))((((int64_t)var_5&3)?class_info[((int64_t)var_5&3)]:var_5->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_5); /* is_ok on <var_5:IndexedIterator[Object]>*/
}
if (var6){
} else {
goto BREAK_label;
...
{
var7 = ((val*(*)(val* self))((((int64_t)var_5&3)?class_info[((int64_t)var_5&3)]:var_5->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_5); /* item on <var_5:IndexedIterator[Object]>*/
}
var_i = var7;
{
var8 = ((val*(*)(val* self))((((int64_t)var_i&3)?class_info[((int64_t)var_i&3)]:var_i->class)->vft[COLOR_core__abstract_text__Object__to_s]))(var_i); /* to_s on <var_i:Object>*/
}
{
...
{
((void(*)(val* self))((((int64_t)var_5&3)?class_info[((int64_t)var_5&3)]:var_5->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_5); /* next on <var_5:IndexedIterator[Object]>*/
}
}
BREAK_label: (void)0;
{
((void(*)(val* self))((((int64_t)var_5&3)?class_info[((int64_t)var_5&3)]:var_5->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_5); /* finish on <var_5:IndexedIterator[Object]>*/
}
{
...
for(;;) {
{
var2 = ((short int(*)(val* self))((((int64_t)var_1&3)?class_info[((int64_t)var_1&3)]:var_1->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_1); /* is_ok on <var_1:IndexedIterator[Array[Object]]>*/
}
if (var2){
} else {
goto BREAK_label;
...
{
var3 = ((val*(*)(val* self))((((int64_t)var_1&3)?class_info[((int64_t)var_1&3)]:var_1->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_1); /* item on <var_1:IndexedIterator[Array[Object]]>*/
}
var_i = var3;
{
...
{
((void(*)(val* self))((((int64_t)var_1&3)?class_info[((int64_t)var_1&3)]:var_1->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_1); /* next on <var_1:IndexedIterator[Array[Object]]>*/
}
}
BREAK_label: (void)0;
{
((void(*)(val* self))((((int64_t)var_1&3)?class_info[((int64_t)var_1&3)]:var_1->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_1); /* finish on <var_1:IndexedIterator[Array[Object]]>*/
}
RET_LABEL:;
}
...
{
var27 = ((val*(*)(val* self))((((int64_t)var26&3)?class_info[((int64_t)var26&3)]:var26->class)->vft[COLOR_core__abstract_text__Object__to_s]))(var26); /* to_s on <var26:nullable Object(Object)>*/
}
{
...
{
var31 = ((val*(*)(val* self))((((int64_t)var30&3)?class_info[((int64_t)var30&3)]:var30->class)->vft[COLOR_core__abstract_text__Object__to_s]))(var30); /* to_s on <var30:nullable Object(Object)>*/
}
{
