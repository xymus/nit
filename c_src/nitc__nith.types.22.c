...
-1, /* empty */
1735, /* HashMapNode[Object, String] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
1736, /* NativeArray[nullable HashMapNode[Object, String]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
1718, /* ArrayIterator[nullable Object] */
1729, /* ArrayIterator[Array[Object]] */
1740, /* ArrayIterator[Array[String]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
1719, /* ArrayReverseIterator[nullable Object] */
1730, /* ArrayReverseIterator[Array[Object]] */
1741, /* ArrayReverseIterator[Array[String]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1744, /* HashMapIterator[String, Int] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
2802, /* nullable HashMapNode[String, Int] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1746, /* NativeArray[nullable HashMapNode[String, Int]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1747, /* MapValuesIterator[String, Int] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1748, /* MapKeysIterator[String, Int] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1749, /* POSetConflictGraph[MClass] */
-1, /* empty */
},
};
...
2930, /* MapRead[MClass, Set[MClass]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1750, /* HashMap[MClass, Set[MClass]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1751, /* HashMapKeys[MClass, Set[MClass]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1752, /* HashMapValues[MClass, Set[MClass]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
2710, /* MapIterator[MClass, Set[MClass]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1753, /* HashMapIterator[MClass, Set[MClass]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
2803, /* nullable HashMapNode[MClass, Set[MClass]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1754, /* HashMapNode[MClass, Set[MClass]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1755, /* NativeArray[nullable HashMapNode[MClass, Set[MClass]]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1756, /* MapValuesIterator[MClass, Set[MClass]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1757, /* MapKeysIterator[MClass, Set[MClass]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1758, /* HashMapKeys[MClass, Set[MVirtualTypeProp]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
2502, /* Collection[nullable Object] */
-1, /* empty */
2504, /* Collection[Set[MVirtualTypeProp]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1759, /* HashMapValues[MClass, Set[MVirtualTypeProp]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
2711, /* MapIterator[MClass, Set[MVirtualTypeProp]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1760, /* HashMapIterator[MClass, Set[MVirtualTypeProp]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
2804, /* nullable HashMapNode[MClass, Set[MVirtualTypeProp]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1761, /* HashMapNode[MClass, Set[MVirtualTypeProp]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1762, /* NativeArray[nullable HashMapNode[MClass, Set[MVirtualTypeProp]]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
2606, /* AbstractArrayRead[Set[MVirtualTypeProp]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
3042, /* AbstractArray[nullable Object] */
-1, /* empty */
3044, /* AbstractArray[Set[MVirtualTypeProp]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1763, /* Array[Set[MVirtualTypeProp]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1764, /* MapValuesIterator[MClass, Set[MVirtualTypeProp]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
1717, /* NativeArray[nullable Object] */
-1, /* empty */
1765, /* NativeArray[Set[MVirtualTypeProp]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1766, /* ArrayIterator[Set[MVirtualTypeProp]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1767, /* ArrayReverseIterator[Set[MVirtualTypeProp]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1768, /* MapKeysIterator[MClass, Set[MVirtualTypeProp]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
2607, /* AbstractArrayRead[MVirtualTypeProp] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
3011, /* AbstractArray[nullable MProperty] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
3045, /* AbstractArray[MVirtualTypeProp] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
&type_core__Array__nitc__MVirtualTypeProp, /* SELF: Array[MVirtualTypeProp] */
...
-1, /* empty */
-1, /* empty */
1770, /* HashSetIterator[MVirtualTypeProp] */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
2805, /* nullable HashSetNode[MVirtualTypeProp] */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1771, /* HashSetNode[MVirtualTypeProp] */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1772, /* NativeArray[nullable HashSetNode[MVirtualTypeProp]] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
...
-1, /* empty */
-1, /* empty */
1773, /* NativeArray[MVirtualTypeProp] */
-1, /* empty */
-1, /* empty */
-1, /* empty */
-1, /* empty */
