...
var_i = 0l;
{
var2 = ((val*(*)(val* self, val* p0, int64_t p1))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__string_search__Pattern__search_in]))(self, var_s, 0l); /* search_in on <self:Pattern>*/
}
var_match = var2;
for(;;) {
if (var_match == NULL) {
...
{
((void(*)(val* self, int64_t p0))(var15->class->vft[COLOR_core__string_search__Match__from_61d]))(var15, var_i); /* from= on <var15:Match>*/
}
{
((void(*)(val* self, int64_t p0))(var15->class->vft[COLOR_core__string_search__Match__length_61d]))(var15, var_len); /* length= on <var15:Match>*/
}
{
...
var_i = var17;
{
var18 = ((val*(*)(val* self, val* p0, int64_t p1))((((int64_t)self&3)?class_info[((int64_t)self&3)]:self->class)->vft[COLOR_core__string_search__Pattern__search_in]))(self, var_s, var_i); /* search_in on <self:Pattern>*/
}
var_match = var18;
} else {
goto BREAK_label;
...
{
var21 = ((int64_t(*)(val* self))(var_s->class->vft[COLOR_core__abstract_text__Text__length]))(var_s); /* length on <var_s:Text>*/
}
{
...
{
((void(*)(val* self, int64_t p0))(var19->class->vft[COLOR_core__string_search__Match__from_61d]))(var19, var_i); /* from= on <var19:Match>*/
}
{
((void(*)(val* self, int64_t p0))(var19->class->vft[COLOR_core__string_search__Match__length_61d]))(var19, var22); /* length= on <var19:Match>*/
}
{
...
int64_t core___core__Match___from(val* self) {
int64_t var /* : Int */;
int64_t var1 /* : Int */;
...
/* method string_search$Match$from= for (self: Match, Int) */
void core___core__Match___from_61d(val* self, int64_t p0) {
...
int64_t core___core__Match___length(val* self) {
int64_t var /* : Int */;
int64_t var1 /* : Int */;
...
/* method string_search$Match$length= for (self: Match, Int) */
void core___core__Match___length_61d(val* self, int64_t p0) {
...
int64_t core___core__Match___after(val* self) {
int64_t var /* : Int */;
int64_t var1 /* : Int */;
int64_t var3 /* : Int */;
int64_t var4 /* : Int */;
...
{
var10 = ((val*(*)(val* self, int64_t p0, int64_t p1))(var1->class->vft[COLOR_core__abstract_text__Text__substring]))(var1, var4, var7); /* substring on <var1:String>*/
}
var = var10;
goto RET_LABEL;
RET_LABEL:;
...
{
var33 = ((int64_t(*)(val* self))(var30->class->vft[COLOR_core__abstract_text__Text__length]))(var30); /* length on <var30:String>*/
}
{
...
int64_t core__string_search___Char___Pattern__search_index_in(uint32_t self, val* p0, int64_t p1) {
int64_t var /* : Int */;
val* var_s /* var s: Text */;
int64_t var_from /* var from: Int */;
int64_t var1 /* : Int */;
int64_t var_stop /* var stop: Int */;
short int var2 /* : Bool */;
short int var4 /* : Bool */;
int cltype;
int idtype;
...
var_from = p1;
{
var1 = ((int64_t(*)(val* self))(var_s->class->vft[COLOR_core__abstract_text__Text__length]))(var_s); /* length on <var_s:Text>*/
}
var_stop = var1;
for(;;) {
{
...
if (var2){
{
var6 = ((uint32_t(*)(val* self, int64_t p0))(var_s->class->vft[COLOR_core__abstract_text__Text___91d_93d]))(var_s, var_from); /* [] on <var_s:Text>*/
}
{
...
int64_t VIRTUAL_core__string_search___Char___Pattern__search_index_in(val* self, val* p0, int64_t p1) {
int64_t var /* : Int */;
int64_t var1 /* : Int */;
uint32_t var2 /* : Char */;
...
val* core__string_search___Char___Pattern__search_in(uint32_t self, val* p0, int64_t p1) {
...
{
((void(*)(val* self, int64_t p0))(var6->class->vft[COLOR_core__string_search__Match__from_61d]))(var6, var_pos); /* from= on <var6:Match>*/
}
{
((void(*)(val* self, int64_t p0))(var6->class->vft[COLOR_core__string_search__Match__length_61d]))(var6, 1l); /* length= on <var6:Match>*/
}
{
...
val* VIRTUAL_core__string_search___Char___Pattern__search_in(val* self, val* p0, int64_t p1) {
val* var /* : nullable Match */;
...
int64_t core__string_search___Text___Pattern__search_index_in(val* self, val* p0, int64_t p1) {
int64_t var /* : Int */;
val* var_s /* var s: Text */;
int64_t var_from /* var from: Int */;
short int var1 /* : Bool */;
...
{
var5 = ((int64_t(*)(val* self))(var_s->class->vft[COLOR_core__abstract_text__Text__length]))(var_s); /* length on <var_s:Text>*/
}
{
...
if (var21){
{
var28 = ((int64_t(*)(val* self))(self->class->vft[COLOR_core__abstract_text__Text__length]))(self); /* length on <self:Text>*/
}
{
...
if (var37){
{
var44 = ((uint32_t(*)(val* self, int64_t p0))(self->class->vft[COLOR_core__abstract_text__Text___91d_93d]))(self, var_i); /* [] on <self:Text>*/
}
{
...
{
var52 = ((uint32_t(*)(val* self, int64_t p0))(var_s->class->vft[COLOR_core__abstract_text__Text___91d_93d]))(var_s, var45); /* [] on <var_s:Text>*/
}
{
...
val* core__string_search___Text___Pattern__search_in(val* self, val* p0, int64_t p1) {
val* var /* : nullable Match */;
val* var_s /* var s: Text */;
int64_t var_from /* var from: Int */;
int64_t var1 /* : Int */;
...
{
((void(*)(val* self, int64_t p0))(var6->class->vft[COLOR_core__string_search__Match__length_61d]))(var6, var8); /* length= on <var6:Match>*/
}
{
((void(*)(val* self))(var6->class->vft[COLOR_core__kernel__Object__init]))(var6); /* init on <var6:Match>*/
}
...
for(;;) {
{
var8 = ((short int(*)(val* self))((((int64_t)var_7&3)?class_info[((int64_t)var_7&3)]:var_7->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_7); /* is_ok on <var_7:IndexedIterator[Match]>*/
}
if (var8){
} else {
goto BREAK_label;
...
{
var9 = ((val*(*)(val* self))((((int64_t)var_7&3)?class_info[((int64_t)var_7&3)]:var_7->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_7); /* item on <var_7:IndexedIterator[Match]>*/
}
var_m = var9;
{
...
{
((void(*)(val* self))((((int64_t)var_7&3)?class_info[((int64_t)var_7&3)]:var_7->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_7); /* next on <var_7:IndexedIterator[Match]>*/
}
}
BREAK_label: (void)0;
{
((void(*)(val* self))((((int64_t)var_7&3)?class_info[((int64_t)var_7&3)]:var_7->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_7); /* finish on <var_7:IndexedIterator[Match]>*/
}
var = var_res;
goto RET_LABEL;
RET_LABEL:;
...
var_pattern = p0;
{
var1 = ((val*(*)(val* self, val* p0, int64_t p1))((((int64_t)var_pattern&3)?class_info[((int64_t)var_pattern&3)]:var_pattern->class)->vft[COLOR_core__string_search__Pattern__search_in]))(var_pattern, self, 0l); /* search_in on <var_pattern:Pattern>*/
}
var_m = var1;
...
{
var13 = ((val*(*)(val* self, int64_t p0, int64_t p1))(self->class->vft[COLOR_core__abstract_text__Text__substring]))(self, 0l, var10); /* substring on <self:Text>*/
}
{
