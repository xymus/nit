...
val* core___core__List___core__abstract_collection__SequenceRead___91d_93d(val* self, int64_t p0) {
...
/* method list$List$[]= for (self: List[nullable Object], Int, nullable Object) */
void core___core__List___core__abstract_collection__Sequence___91d_93d_61d(val* self, int64_t p0, val* p1) {
short int var /* : Bool */;
int cltype;
int idtype;
...
if(cltype4 >= (((int64_t)var_item&3)?type_info[((int64_t)var_item&3)]:var_item->type)->table_size) {
var3 = 0;
} else {
var3 = (((int64_t)var_item&3)?type_info[((int64_t)var_item&3)]:var_item->type)->type_table[cltype4] == idtype5;
}
}
if (unlikely(!var3)) {
var_class_name8 = var_item == NULL ? "null" : (((int64_t)var_item&3)?type_info[((int64_t)var_item&3)]:var_item->type)->name;
...
if(cltype4 >= (((int64_t)var_e&3)?type_info[((int64_t)var_e&3)]:var_e->type)->table_size) {
var3 = 0;
} else {
var3 = (((int64_t)var_e&3)?type_info[((int64_t)var_e&3)]:var_e->type)->type_table[cltype4] == idtype5;
}
}
if (unlikely(!var3)) {
var_class_name8 = var_e == NULL ? "null" : (((int64_t)var_e&3)?type_info[((int64_t)var_e&3)]:var_e->type)->name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "E", var_class_name8);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 340);
fatal_exit(1);
}
...
int64_t core___core__List___core__abstract_collection__Collection__length(val* self) {
int64_t var /* : Int */;
int64_t var1 /* : Int */;
...
/* method list$List$length= for (self: List[nullable Object], Int) */
void core___core__List___length_61d(val* self, int64_t p0) {
...
if(cltype >= (((int64_t)var_e&3)?type_info[((int64_t)var_e&3)]:var_e->type)->table_size) {
var1 = 0;
} else {
var1 = (((int64_t)var_e&3)?type_info[((int64_t)var_e&3)]:var_e->type)->type_table[cltype] == idtype;
}
}
if (unlikely(!var1)) {
var_class_name = var_e == NULL ? "null" : (((int64_t)var_e&3)?type_info[((int64_t)var_e&3)]:var_e->type)->name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "E", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__list, 49);
fatal_exit(1);
}
...
int64_t core___core__List___core__abstract_collection__Collection__count(val* self, val* p0) {
int64_t var /* : Int */;
val* var_e /* var e: nullable Object */;
...
var11 = ((short int(*)(val* self, val* p0))((((int64_t)var7&3)?class_info[((int64_t)var7&3)]:var7->class)->vft[COLOR_core__kernel__Object___33d_61d]))(var7, var_e); /* != on <var7:nullable Object>*/
var10 = var11;
}
if (var10){
{
...
void core___core__List___core__abstract_collection__Sequence__insert(val* self, val* p0, int64_t p1) {
short int var /* : Bool */;
int cltype;
int idtype;
const struct type* type_struct;
...
var = (((int64_t)var_e&3)?type_info[((int64_t)var_e&3)]:var_e->type)->type_table[cltype] == idtype;
}
}
if (unlikely(!var)) {
var_class_name = var_e == NULL ? "null" : (((int64_t)var_e&3)?type_info[((int64_t)var_e&3)]:var_e->type)->name;
...
void core___core__List___core__abstract_collection__Sequence__remove_at(val* self, int64_t p0) {
int64_t var_i /* var i: Int */;
...
val* core___core__List___get_node(val* self, int64_t p0) {
val* var /* : nullable ListNode[nullable Object] */;
int64_t var_i /* var i: Int */;
val* var1 /* : nullable ListNode[nullable Object] */;
...
var17 = ((short int(*)(val* self, val* p0))((((int64_t)var13&3)?class_info[((int64_t)var13&3)]:var13->class)->vft[COLOR_core__kernel__Object___33d_61d]))(var13, var_e); /* != on <var13:nullable Object>*/
var16 = var17;
}
var7 = var16;
} else {
...
int64_t core___core__ListIterator___core__abstract_collection__IndexedIterator__index(val* self) {
int64_t var /* : Int */;
int64_t var1 /* : Int */;
