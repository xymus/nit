...
#define COLOR_opts___opts__OptionParameter___Option__read_param 31
...
#define COLOR_opts__OptionParameter__convert 30
...
#define COLOR_opts__Option__read_param 24
