...
var52 = "AUTOSUB";
var53 = core__flat___NativeString___to_s_full(var52, 7l, 7l);
var51 = var53;
varonce = var51;
}
{
...
for(;;) {
{
var11 = ((short int(*)(val* self))((((int64_t)var_10&3)?class_info[((int64_t)var_10&3)]:var_10->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_10); /* is_ok on <var_10:IndexedIterator[AEscapeExpr]>*/
}
if (var11){
} else {
goto BREAK_label;
...
{
var12 = ((val*(*)(val* self))((((int64_t)var_10&3)?class_info[((int64_t)var_10&3)]:var_10->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_10); /* item on <var_10:IndexedIterator[AEscapeExpr]>*/
}
var_b = var12;
{
...
{
((void(*)(val* self))((((int64_t)var_10&3)?class_info[((int64_t)var_10&3)]:var_10->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_10); /* next on <var_10:IndexedIterator[AEscapeExpr]>*/
}
}
BREAK_label: (void)0;
{
((void(*)(val* self))((((int64_t)var_10&3)?class_info[((int64_t)var_10&3)]:var_10->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_10); /* finish on <var_10:IndexedIterator[AEscapeExpr]>*/
}
RET_LABEL:;
}
...
var29 = core__flat___NativeString___to_s_full(var28, 29l, 29l);
var27 = var29;
varonce = var27;
}
{
...
var20 = "AND FALSE";
var21 = core__flat___NativeString___to_s_full(var20, 9l, 9l);
var19 = var21;
varonce = var19;
}
{
