...
#define COLOR_ini___ini__ConfigTree___core__kernel__Object__init 24
...
#define COLOR_ini__ConfigNode__name_61d 17
...
#define COLOR_ini___ini__ConfigNode___core__kernel__Object__init 21
