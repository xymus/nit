...
var1 = NEW_core__HashSet((((int64_t)self&3)?type_info[((int64_t)self&3)]:self->type)->resolution_table->types[COLOR_core__HashSet__core__Set___35dE]);
{
...
int64_t core__hash_collection___core__hash_collection__HashCollection___index_at(val* self, val* p0) {
int64_t var /* : Int */;
...
if (0) {
var2 = ((short int(*)(val* self, val* p0))((((int64_t)var_k&3)?class_info[((int64_t)var_k&3)]:var_k->class)->vft[COLOR_core__kernel__Object___61d_61d]))(var_k, ((val*)NULL)); /* == on <var_k:nullable Object>*/
var1 = var2;
}
if (var1){
var = 0l;
...
{
var3 = ((int64_t(*)(val* self))((((int64_t)var_k&3)?class_info[((int64_t)var_k&3)]:var_k->class)->vft[COLOR_core__kernel__Object__hash]))(var_k); /* hash on <var_k:nullable Object(Object)>*/
}
...
val* core__hash_collection___core__hash_collection__HashCollection___node_at_idx(val* self, int64_t p0, val* p1) {
val* var /* : nullable HashNode[nullable Object] */;
int64_t var_i /* var i: Int */;
val* var_k /* var k: nullable Object */;
int64_t var1 /* : Int */;
...
var21 = ((short int(*)(val* self, val* p0))((((int64_t)var_ck&3)?class_info[((int64_t)var_ck&3)]:var_ck->class)->vft[COLOR_core__kernel__Object___61d_61d]))(var_ck, var_k); /* == on <var_ck:nullable Object>*/
var20 = var21;
}
var15 = var20;
}
...
void core__hash_collection___core__hash_collection__HashCollection___store(val* self, int64_t p0, val* p1) {
short int var /* : Bool */;
int cltype;
int idtype;
const struct type* type_struct;
...
void core__hash_collection___core__hash_collection__HashCollection___enlarge(val* self, int64_t p0) {
...
int64_t core__hash_collection___core__hash_collection__HashMapKeys___core__abstract_collection__Collection__count(val* self, val* p0) {
int64_t var /* : Int */;
val* var_k /* var k: nullable Object */;
short int var1 /* : Bool */;
var_k = p0;
...
int64_t core__hash_collection___core__hash_collection__HashMapKeys___core__abstract_collection__Collection__length(val* self) {
int64_t var /* : Int */;
val* var1 /* : HashMap[nullable Object, nullable Object] */;
val* var3 /* : HashMap[nullable Object, nullable Object] */;
int64_t var4 /* : Int */;
...
int64_t core__hash_collection___core__hash_collection__HashMapValues___core__abstract_collection__Collection__count(val* self, val* p0) {
int64_t var /* : Int */;
...
var12 = ((short int(*)(val* self, val* p0))((((int64_t)var10&3)?class_info[((int64_t)var10&3)]:var10->class)->vft[COLOR_core__kernel__Object___61d_61d]))(var10, var_item); /* == on <var10:nullable Object>*/
var11 = var12;
}
if (var11){
{
...
int64_t core__hash_collection___core__hash_collection__HashMapValues___core__abstract_collection__Collection__length(val* self) {
int64_t var /* : Int */;
val* var1 /* : HashMap[nullable Object, nullable Object] */;
val* var3 /* : HashMap[nullable Object, nullable Object] */;
int64_t var4 /* : Int */;
...
var11 = ((short int(*)(val* self, val* p0))((((int64_t)var9&3)?class_info[((int64_t)var9&3)]:var9->class)->vft[COLOR_core__kernel__Object___61d_61d]))(var9, var_item); /* == on <var9:nullable Object>*/
var10 = var11;
}
if (var10){
...
int64_t core___core__HashSet___core__abstract_collection__Collection__length(val* self) {
int64_t var /* : Int */;
int64_t var1 /* : Int */;
