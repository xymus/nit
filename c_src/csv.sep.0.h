...
#define COLOR_csv__CsvWriter__ostream_61d 18
...
#define COLOR_csv___csv__CsvDocument___core__kernel__Object__init 23
#define COLOR_csv__CsvWriter___ostream 3
...
#define COLOR_csv___csv__CsvWriter___core__kernel__Object__init 22
